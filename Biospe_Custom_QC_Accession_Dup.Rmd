...
homsetting <- HMW %>%  filter(((d_173836415_d_266600170_d_319972665_d_221592017=="Received" & d_173836415_d_266600170_d_319972665_d_379252329==976461859) | (d_173836415_d_266600170_d_541483796_d_221592017=="Received" & d_173836415_d_266600170_d_541483796_d_379252329==976461859) | (d_173836415_d_266600170_d_641006239_d_221592017=="Received" & d_173836415_d_266600170_d_641006239_d_379252329==976461859)) & d_173836415_d_266600170_d_915179629!=103209024) %>% 
...
r1_r2_undeliverable <- HMW %>%  filter(d_173836415_d_266600170_d_641006239_d_221592017=="332067457" & (d_426588510=="Replacement Kit 1" | d_426588510=="Replacement Kit 2")) %>% 
...
BioChk_TimeBL_v1r0_RschTmBL <- parts_data %>%  filter(as.POSIXct(d_331584571_d_266600170_d_840048338) > pmin(as.POSIXct(d_173836415_d_266600170_d_561681068), as.POSIXct(d_173836415_d_266600170_d_847159717), na.rm=T)) %>% 
...
###	78. Draw order placement (BioClin_BldUrnPlcdTmBL_v1r0 or BioClin_UrnOrdPlcdDtBL_v1r0) should not occur more than 4 days prior to verification (RcrtV_VerificationTm_v1r0).

# DrawOrder_Verif4 <- bioqc %>%  filter(as.numeric(difftime(d_914594314, d_173836415_d_266600170_d_184451682, units="days")) > 4 | 
#                                         as.numeric(difftime(d_914594314, d_173836415_d_266600170_d_939818935, units="days")) > 4) %>% 
...
# 
# 
# colnames(DrawOrder_Verif4) <- c("Site", "Connect ID", "RcrtV_VerificationTm", "BioClin_BldUrnPlcdTmBL", "BioClin_UrnOrdPlcdDtBL")
