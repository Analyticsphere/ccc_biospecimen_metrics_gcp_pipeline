...
c_blood3.1 <- bioqc %>%  filter(d_878865966=="353358909" & d_173836415_d_266600170_d_592099155=="664882224" & is.na(d_173836415_d_266600170_d_982213346)) %>% 
...
### 30.a. If BioFin_BaseUrineCol_v1r0= yes, and BioSpm_UrineSettingBL_v1r0= Clinical, then BioClin_ClinicalUrnTmBL_v1r0 must be populated.
```{r All3_C_U1, echo=FALSE, warning=FALSE, message=FALSE}

c_urine3.1 <- bioqc %>%  filter(d_167958071=="353358909" & d_173836415_d_266600170_d_718172863=="664882224" & is.na(d_173836415_d_266600170_d_139245758))  %>%  
