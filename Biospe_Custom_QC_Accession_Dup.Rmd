...
#add to my rule list 
qc14_tube8 <- bioqc %>%  filter(d_505347689_d_593843561==104430631 & d_650516960== 534621077 & is.na(d_505347689_d_883732523)) %>% 
    select(Site, Connect_ID, d_505347689_d_883732523) %>%  sort_by(Site)
