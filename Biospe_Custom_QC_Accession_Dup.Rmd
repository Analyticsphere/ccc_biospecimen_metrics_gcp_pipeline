...
WHERE (d_820476880 LIKE 'CHA%') 
   OR (d_820476880 LIKE 'CXA%' AND Connect_ID IN (SELECT Connect_ID FROM T));"
...
\newpage
\FloatBarrier
## 29. BioClin_DBBloodID_v1r0 must be in BioClin_PolyBloodID_v1r0 if and BioClin_DBBloodRRLDt_v1r0 occured more than 7 days ago
...
bioqc1 <- bioqc %>%
  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0)) > 7 &
           ...
           Connect_ID != 6336258662 &
           Connect_ID != 5461650381 &
           Connect_ID != 4900116130 &
           Connect_ID != 4462616750 &
           Connect_ID != 9111871102 &
           Connect_ID != 8476952861 &
           Connect_ID != 2974054638 & # HFH exclusions
           Connect_ID != 4782195164 & 
           Connect_ID != 6229346420 &# UC exclusions
           Connect_ID != 8336144924 &
           Connect_ID != 7515171846 #SF exclusions
  )
# 
...
\FloatBarrier
## 30. BioClin_DBUrineID_v1r0 must be in BioClin_PolyUrineID_v1r0 if BioClin_DBUrineRRLDt_v1r0 occurred more than seven days ago.
...
bioqc2 <- bioqc %>%  filter( as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_541311218, units="days"), digits=0)) > 7 &
                               ...
                               Connect_ID!=6473532641 & Connect_ID!=4435276749 & Connect_ID!=4900116130 & Connect_ID!=5461650381 ) #HFH exclusions)
