...
qc2_1 <- bioqc %>%  filter( d_232343615_d_593843561==104430631 & d_299553921_d_593843561==104430631 & d_376960806_d_593843561==104430631 & d_454453939_d_593843561==104430631 &
                              ...
                              d_703954371_d_593843561==104430631 & d_838567176_d_593843561==104430631 &  d_173836415_d_266600170_d_693370086==353358909 & 
                              Connect_ID!=2300063524 & Connect_ID!=7848933050) #specific exclusion- not editing this persons data
...
qc2_1a <- bioqc %>%  filter( d_973670172_d_593843561==104430631  & d_173836415_d_266600170_d_786930107==353358909 &
...
# qc2_1b <- bioqc %>%  filter( d_973670172_d_593843561==104430631  & d_173836415_d_266600170_d_786930107==353358909) %>%  
...
qc13_tube_sst3 <- bioqc %>%  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0))>4 & d_376960806_d_593843561==353358909 & d_376960806_d_762124027==104430631 & is.na(d_376960806_d_926457119)) %>% 
...
qc13_tube_sst4 <- bioqc %>%  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0))>4 & d_232343615_d_593843561==353358909 & d_232343615_d_762124027==104430631 & is.na(d_232343615_d_926457119)) %>% 
...
qc13_tube_sst5 <- bioqc %>%  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0))>4 & d_589588440_d_593843561==353358909 & d_589588440_d_762124027==104430631 & is.na(d_589588440_d_926457119)) %>% 
...
qc13_tube_edat2 <- bioqc %>%  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0))>4 & d_677469051_d_593843561==353358909 & d_677469051_d_762124027==104430631 & is.na(d_677469051_d_926457119) & 
                                  Connect_ID!="9729007313") %>% 
...
qc13_tube_edat3 <- bioqc %>%  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0))>4 & d_683613884_d_593843561==353358909 & d_683613884_d_762124027==104430631 & is.na(d_683613884_d_926457119) & 
                                  Connect_ID!="9729007313") %>% 
...
r_blood3.1 <- bioqc %>%  filter(d_878865966=="353358909" & d_173836415_d_266600170_d_592099155=="534621077" & is.na(d_173836415_d_266600170_d_561681068))  %>%  
...
r_blood3.2 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_592099155) & d_878865966=="104430631") %>% 
...
r_blood3.3 <- bioqc %>%  filter(d_878865966=="353358909" & is.na(d_173836415_d_266600170_d_592099155)) %>%  #not all populated
...
r_blood3.4 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_561681068) & (d_173836415_d_266600170_d_592099155=="664882224" | is.na(d_173836415_d_266600170_d_592099155) | d_878865966=="104430631")) %>% 
    select(Site, Connect_ID, d_878865966, d_173836415_d_266600170_d_592099155, d_173836415_d_266600170_d_561681068) %>%  sort_by(Site)
...
r_urine3.1 <- bioqc %>% filter(d_167958071=="353358909" & d_173836415_d_266600170_d_718172863=="534621077" & is.na(d_173836415_d_266600170_d_847159717)) %>% 
...
r_urine3.2 <- bioqc %>% filter(!is.na(d_173836415_d_266600170_d_718172863) & d_167958071=="104430631") %>% 
...
r_urine3.3 <- bioqc %>% filter(d_167958071=="353358909" & is.na(d_173836415_d_266600170_d_718172863)) %>% 
    select(Site, Connect_ID, d_167958071, d_173836415_d_266600170_d_718172863) %>%  sort_by(Site)
...
r_urine3.4 <- bioqc %>% filter(!is.na(d_173836415_d_266600170_d_847159717) & (d_173836415_d_266600170_d_718172863=="664882224" | is.na(d_173836415_d_266600170_d_718172863) | d_167958071=="104430631")) %>% 
    select(Site, Connect_ID, d_167958071, d_173836415_d_266600170_d_718172863, d_173836415_d_266600170_d_847159717) %>%  sort_by(Site)
...
r_mw3.1 <- bioqc %>%  filter(d_684635302=="353358909" & !is.na(d_173836415_d_266600170_d_915179629) & is.na(d_173836415_d_266600170_d_448660695)) %>% 
...
r_mw3.2 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_915179629) & d_684635302=="104430631") %>%  
...
r_mw3.3 <- bioqc %>%  filter(d_684635302=="353358909" & is.na(d_173836415_d_266600170_d_915179629)) %>%  #not all populated
    select(Site, Connect_ID, d_684635302, d_173836415_d_266600170_d_915179629) %>%  sort_by(Site)
...
r_mw3.4 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_448660695) & (is.na(d_173836415_d_266600170_d_915179629) | d_684635302=="104430631")) %>%  
    select(Site, Connect_ID, d_684635302, d_173836415_d_266600170_d_915179629, d_173836415_d_266600170_d_448660695) %>%  sort_by(Site)
...
c_blood3.1 <- bioqc %>%  filter(d_878865966=="353358909" & d_173836415_d_266600170_d_592099155=="664882224" & 
...
c_urine3.1 <- bioqc %>%  filter(d_167958071=="353358909" & d_173836415_d_266600170_d_718172863=="664882224" & 
...
c_urine3.4 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_139245758) & d_173836415_d_266600170_d_718172863=="664882224" & d_167958071=="104430631")  %>%  
    select(Site, Connect_ID, d_167958071, d_173836415_d_266600170_d_718172863, d_173836415_d_266600170_d_139245758) %>%  sort_by(Site)
...
no_db_blood <- bioqc %>%  filter(d_173836415_d_266600170_d_693370086=="353358909" & d_878865966=="104430631")  %>%  
...
no_db_urine <- bioqc %>%  filter(d_173836415_d_266600170_d_786930107=="353358909" & d_167958071=="104430631")  %>%  
...
bioqc1 <- bioqc %>%
  filter(as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0)) > 7 &
           ...
           Connect_ID != 2974054638 & 
           Connect_ID != 3544623873 &
           Connect_ID != 3293040395 &
           Connect_ID != 7571439842 &
           Connect_ID != 3165368475 &
           Connect_ID != 6954174713 &
           Connect_ID != 6361337944 &
           Connect_ID != 1629086681 &
           Connect_ID != 3544623873 &
           Connect_ID != 3293040395 &
           Connect_ID != 7571439842 &
           Connect_ID != 3165368475 &
           ...
           Connect_ID != 6361337944 &
           Connect_ID != 1629086681 &
           Connect_ID != 9768745029 &
           Connect_ID != 3770024701 &
           Connect_ID != 8836251245 &
           Connect_ID != 3312148528 &# HFH exclusions
           Connect_ID != 4782195164 & 
           Connect_ID != 6229346420 &# UC exclusions
           Connect_ID != 8336144924 &
           Connect_ID != 7515171846 &
           Connect_ID != 9963945282 & 
           Connect_ID != 9554775290 & 
           Connect_ID != 8570090186 & 
           Connect_ID != 4727512872 &
           Connect_ID != 5506703775 &
           Connect_ID != 8123989364 &
           Connect_ID != 9843228847 & #SF exclusions ##this last one is somehow being shown as an error when it is not. Cannot find a workaround
...
bio_dup= left_join(dup_data, parts_data2, by=c("Connect_ID", "d_827220437") )
...
blood_loc <- bioqc %>%  filter(d_878865966==353358909 & d_173836415_d_266600170_d_592099155==664882224 & as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0)) > 7  & 
...
colnames(blood_loc) <- c("Site", "Connect ID", "BioClin_DBBloodRRLDtBL_v1r0", "BioClin_SiteBldLocBL_v1r0")
...
blood_locPL <- bioqc %>%  filter(d_878865966==353358909 & d_173836415_d_266600170_d_592099155==664882224 & as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_398645039, units="days"), digits=0)) > 7  & 
...
urine_loc <- bioqc %>%  filter(d_167958071==353358909 & d_173836415_d_266600170_d_718172863==664882224 & as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_541311218, units="days"), digits=0)) > 7  & 
...
urine_locPL <- bioqc %>%  filter(d_167958071==353358909 & d_173836415_d_266600170_d_718172863==664882224 & as.numeric(round(difftime(currentDate, d_173836415_d_266600170_d_541311218, units="days"), digits=0)) > 7  & 
