...
### If the Urine tube is collected and BioSpm_Setting_v1r0= Clinical then BioSpm_BloodSettingBL_v1r0 must be Clinical.
```{r Clin_SiteBloodColl, echo=FALSE, warning=FALSE, message=FALSE}

bioqc %>%  filter((d_973670172_d_593843561==353358909) & d_650516960==664882224 & d_173836415_d_266600170_d_592099155 !=664882224)
                              
                              
```  

### If the Urine tube is collected and BioSpm_Setting_v1r0= Research then BioSpm_BloodSettingBL_v1r0 must be Research.
```{r Clin_SiteBloodColl, echo=FALSE, warning=FALSE, message=FALSE}

bioqc %>%  filter((d_973670172_d_593843561==353358909) & d_650516960==534621077 & d_173836415_d_266600170_d_592099155 !=534621077)
                              
                              
```  

                              
### If the Mouthwash tube is collected and BioSpm_Setting_v1r0= Clinical then BioSpm_BloodSettingBL_v1r0 must be Clinical.
```{r Clin_SiteBloodColl, echo=FALSE, warning=FALSE, message=FALSE}

bioqc %>%  filter((d_143615646_d_593843561==353358909) & d_650516960==664882224 & d_173836415_d_266600170_d_592099155 !=664882224)
                              
                              
```  

### If the Mouthwash tube is collected and BioSpm_Setting_v1r0= Research then BioSpm_BloodSettingBL_v1r0 must be Research.
```{r Clin_SiteBloodColl, echo=FALSE, warning=FALSE, message=FALSE}

bioqc %>%  filter((d_143615646_d_593843561==353358909) & d_650516960==534621077 & d_173836415_d_266600170_d_592099155 !=534621077)
