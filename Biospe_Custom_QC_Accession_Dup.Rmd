...
qc2_1a <- qc2_1a  %>% select(Site, Connect_ID, d_173836415_d_266600170_d_786930107)  %>%  sort_by(Site)


colnames(qc2_1a) <- c("Site", "Connect ID", "Value")
knitr::kable(qc2_1a)

#write.csv(qc2_1a,paste0('Github_Issue_190_Urine_Rule', Sys.Date(), '.csv'), row.names = F,na="")
...
c_blood3.4 <- bioqc %>%  filter(!is.na(d_173836415_d_266600170_d_982213346) & ((d_173836415_d_266600170_d_592099155=="534621077" | is.na(d_173836415_d_266600170_d_592099155)) | d_878865966=="104430631")) %>% 
    select(Site, Connect_ID, d_878865966, d_173836415_d_266600170_d_592099155, d_173836415_d_266600170_d_982213346) %>%  sort_by(Site)
