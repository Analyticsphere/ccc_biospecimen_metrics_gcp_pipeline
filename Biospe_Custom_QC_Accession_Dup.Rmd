...
no_db_blood <- bioqc %>%  filter(d_173836415_d_266600170_d_693370086=="353358909" & d_878865966=="No")  %>%  
...
no_db_urine <- bioqc %>%  filter(d_173836415_d_266600170_d_786930107=="353358909" & d_167958071=="No")  %>%  
