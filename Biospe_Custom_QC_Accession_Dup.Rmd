...
### 37. If kit status is Assigned, then supply kit tracking number and kit level (BioKit_KitLevel_v1r0) should populate
...
asgn <- HMW %>%  filter(d_173836415_d_266600170_d_319972665_d_221592017==241974920 & (is.na(d_531858099) | is.na(d_426588510))) %>% 
...
### 38. If kit status is Shipped, then supply kit tracking number, date/time kit shipped, and kit level (BioKit_KitLevel_v1r0) should populate
...
### 39. If kit status is Received, then supply kit tracking number, date/time kit shipped, date/time kit received, and kit level (BioKit_KitLevel_v1r0) should populate
...
recvd <- HMW %>%  filter(d_173836415_d_266600170_d_319972665_d_221592017==375535639 & (is.na(d_531858099) | is.na(d_661940160) |
  ...
  select(Site, Connect_ID, d_531858099, d_661940160, d_826941471, d_137401245) %>%  safe_arrange(Site)
...
kits_recvd <- HMW %>%  filter(#d_173836415_d_266600170_d_915179629==103209024 & #--- sometimes this is null, sometimes its home 
                                  ...
                                  d_173836415_d_266600170_d_319972665_d_221592017!="375535639") %>% 
  select(Site, Connect_ID, d_195145666, d_972453354) %>%  safe_arrange(Site)
