...
no_db_blood <- bioqc %>%  filter(d_173836415_d_266600170_d_693370086=="Yes" & d_878865966=="No")  %>%  
    select(Site, Connect_ID, d_173836415_d_266600170_d_693370086, d_878865966) %>%  safe_arrange(Site)
...
#     select(Site, Connect_ID, d_173836415_d_266600170_d_786930107, d_167958071) %>%  safe_arrange(Site)
# 
# 
