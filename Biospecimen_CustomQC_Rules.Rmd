...
### 5. If BioClin_BldOrderPlacdDt_v1r0 occurred before BioClin_UrnOrderPlacdDt_v1r0, then BioClin_BldUrnPlacedTm_v1r0 should = BioClin_BldOrderPlacdDt_v1r0
...
### 6. If BioClin_BldOrderPlacdDt_v1r0 occurred after BioClin_UrnOrderPlacdDt_v1r0, then BioClin_BldUrnPlacedTm_v1r0 should = BioClin_UrnOrderPlacdDt_v1r0
...
###	7. If BioFin_BaseUrineCol_v1r0 was collected, BioSpm_BloodSettingBL_v1r0 is clinical, and BioClin_DBUrineRRLDt_v1r0 occurred more than seven days ago, BioClin_SiteUrineColl_v1r0 must be yes
...
###	8. If BioFin_BaseBloodCol_v1r0 = yes, collection setting is clinical and BioClin_DBBloodRRLDtBL_v1r0 occurred more than 7 days ago, BioClin_SiteBloodColl_v1r0 must be yes
...
\newpage
\FloatBarrier
### 31. BioClin_DBBloodID_v1r0 must be in BioClin_PolyBloodID_v1r0 if and BioClin_DBBloodRRLDt_v1r0 occurred more than 7 days ago
...
```{r DrawOrder_Verif30, echo=FALSE, warning=FALSE, message=FALSE}
 ...
 colnames(DrawOrder_verif) <- c("Site", "Connect ID", "RcrtV_VerificationTm", "BioClin_BldUrnPlcdTmBL")
 knitr::kable(DrawOrder_verif, longtable = TRUE)  %>% kable_styling(latex_options = "scale_down", full_width = FALSE, font_size=8)

```

###	80. Clinical collection date (BioClin_ClinBloodTmBL_v1r0 or BioClin_ClinicalUrnTmBL_v1r0) should not precede draw order date (BioClin_BldUrnPlcdTmBL_v1r0) by more than 2 days.
...
colnames(DrawOrder_Colct2) <- c("Site", "Connect ID", "BioClin_BldUrnPlcdTmBL", "BioClin_ClinBloodTmBL", "BioClin_ClinicalUrnTmBL")
