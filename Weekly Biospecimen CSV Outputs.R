...
write.xlsx(box1,glue("Formatted_prod_flatBoxes_JP_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
...
write.xlsx(biospe1_final,glue("Connect_prod_Biospe_Formats_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
...
write.xlsx(recrbio_1,glue("Connect_prod_recr_veriBiospe_Formats_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
...
write.xlsx(kitA_table,glue("Connect_prod_KitAssembly_Table_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
