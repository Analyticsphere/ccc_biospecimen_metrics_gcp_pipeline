...
#MENSTPRD
menstrual_funct(BU_tib,D_380603392, "MENSTPRD: Had Menstrual Period in the Last 12 Months",
                   factor_levels = c("Yes", "No"))


#MENST60
one_logic_funct(BU_tib,D_112151599, "MENST60: Had Menstrual Period in the Last 60 Days", D_380603392, "353358909",
                   factor_levels = c("Yes", "No")) 
...
#PREGNANT
menstrual_funct(BU_tib,D_518916981, "PREGNANT: Currently Pregnant",
                   factor_levels = c("Yes", "No"))

#PREG3MON
one_logic_funct(BU_tib,D_234714655, "Table 13: Been Pregnant in the Last 3 Months", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 

#BRSTFD
menstrual_funct(BU_tib,D_798452445, "Table 14: Currently Breastfeeding",
                   factor_levels = c("Yes", "No"))

#BRSTFD3MON
one_logic_funct(BU_tib,D_563539159, "Table 15: Breastfed in the Last 3 Months", D_798452445, "104430631",
                   factor_levels = c("Yes", "No")) 

#CONTRACEPT
one_logic_funct(BU_tib,D_875535246, "Table 16: Used Hormonal Contraceptives in the Last Month", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 

#HORMONE
one_logic_funct(BU_tib,D_130311122, "Table 17: Used Prescription Hormone Therapy in the Last Month", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 
