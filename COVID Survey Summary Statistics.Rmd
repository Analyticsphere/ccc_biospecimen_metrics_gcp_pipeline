...
dict <- list("104430631"="No", "353358909"="Yes", "178420302"="Do not Know",
             "317811347"="Do not Know",
...
#COV1
simple_funct(CVD_tib,D_494226443, "Ever Have COVID-19", 
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV2
#qc issue of participants putting in year of diagnosis instead of times having covid
CVD_tib <- CVD_tib %>% mutate(D_860011428_num = case_when(as.numeric(D_860011428)<100 ~ D_860011428,
                                                          TRUE ~ NA))
cov2 <- hist_funct(CVD_tib,D_860011428_num, "Times Having COVID-19", "Times", "Frequency")
cov2 + scale_x_continuous(breaks = breaks_width(1)) +
  labs(caption="Participants that put values over 99 are a quality control issue and have been exlcuded from this plot.")
...
simple_funct(dt_select2, D_498462481_1_1, "HealthCare Provider Confirm Diagnosis the First Time Having COVID-19",
...
#COV7
one_logic_funct(CVD_tib,D_451163824_1_1, D_694503437_1_1, "353358909", "Worst Symptoms Interfere with Daily Activities the First Time Having COVID-19",
               factor_levels = c("Not at all",
...
final_symptoms <- symptom_combos_filtered %>%
  mutate(`N (%)` = fmt_count_pct(N, nrow(COVID_tib8), digits = 1)) %>%
...
#COV9
one_logic_funct(CVD_tib,D_928530823_1_1, D_694503437_1_1, "353358909", "Experience Septic Shock the First Time Having COVID-19",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV10
one_logic_funct(CVD_tib,D_108733102_1_1, D_694503437_1_1, "353358909", "Diagnosed with Pneumonia the First Time Having COVID-19",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV11
one_logic_funct(CVD_tib,D_389465772_1_1, D_694503437_1_1, "353358909", "Diagnosed with Bood Clots the First Time Having COVID-19",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV12
one_logic_funct(CVD_tib,D_775313030_1_1, D_694503437_1_1, "353358909", "Overnight Hospital Stay the First Time Having COVID-19",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV13
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_744230001_1_1, "Nights in the Hospital the First Time Having COVID-19", "Nights", "Count")

#COV14A
one_logic_funct(CVD_tib,D_782396371_1_1, D_775313030_1_1, "353358909", "Given Oxygen in the Hospital the First Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV14B
hist_funct(CVD_tib,D_930944000_1_1, "Days Treated with Oxygen in the Hospital the First Time Having COVID-19", "Days", "Count")

#COV15A
one_logic_funct(CVD_tib,D_984121390_1_1, D_775313030_1_1, "353358909", "Given Breathing Tube or Ventilator in the Hospital the First Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV15B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_930944000_1_1, "Days Treated with Breathing Tube or Ventilator the First Time Having COVID-19", "Days", "Count")

#COV16A
one_logic_funct(CVD_tib,D_179406442_1_1, D_775313030_1_1, "353358909", "ICU monitoring in the Hospital the First Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV16B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_803339020_1_1, "Days Treated with ICU monitoring the First Time Having COVID-19", "Days", "Count")

#COV17A
one_logic_funct(CVD_tib,D_893966847_1_1, D_775313030_1_1, "353358909", "Receive Dialysis Treatment in the Hospital the First Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV17B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_169509213_1_1, "Days Treated with Dialysis the First Time Having COVID-19", "Days", "Count")
...
simple_funct(dt_select2, D_498462481_2_2, "HealthCare Provider Confirm Diagnosis the Second Time Having COVID-19",
factor_levels = c("Yes", "No"))
...
#COV7
one_logic_funct(CVD_tib,D_451163824_2_2, D_694503437_2_2, "353358909", "Worst Symptoms Interfere with Daily Activities the Second Time Having COVID-19",
               factor_levels = c("Not at all",
                  "A little bit", "Somewhat", "Quite a bit", "Very Much"))
...
#COV9
one_logic_funct(CVD_tib,D_928530823_2_2, D_694503437_2_2, "353358909", "Experience Septic Shock the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV10
one_logic_funct(CVD_tib,D_108733102_2_2, D_694503437_2_2, "353358909", "Diagnosed with Pneumonia the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV11
one_logic_funct(CVD_tib,D_389465772_2_2, D_694503437_2_2, "353358909", "Diagnosed with Bood Clots the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV12
one_logic_funct(CVD_tib,D_775313030_2_2, D_694503437_2_2, "353358909", "Overnight Hospital Stay the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV13
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_744230001_2_2, "Nights in the Hospital the Second Time Having COVID-19", "Nights", "Count")

#COV14A
one_logic_funct(CVD_tib,D_782396371_2_2, D_775313030_2_2, "353358909", "Given Oxygen in the Hospital the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV14B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_930944000_2_2, "Days Treated with Oxygen in the Hospital the Second Time Having COVID-19", "Days", "Count")

#COV15A
one_logic_funct(CVD_tib,D_984121390_2_2, D_775313030_2_2, "353358909", "Given Breathing Tube or Ventilator in the Hospital the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV15B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_930944000_2_2, "Days Treated with Breathing Tube or Ventilator the Second Time Having COVID-19", "Days", "Count")

#COV16A
one_logic_funct(CVD_tib,D_179406442_2_2, D_775313030_2_2, "353358909", "ICU monitoring in the Hospital the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV16B
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_803339020_2_2, "Days Treated with ICU monitoring the Second Time Having COVID-19", "Days", "Count")

#COV17A
one_logic_funct(CVD_tib,D_893966847_2_2, D_775313030_2_2, "353358909", "Receive Dialysis Treatment in the Hospital the Second Time Having COVID-19",
factor_levels = c("Yes", "No", "Do not Know"))

#COV17B-- no one answered yet 
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_169509213_2_2, "Days Treated with Dialysis the Second Time Having COVID-19", "Days", "Count")
```
...
simple_funct(which_symptA1, symptom, "Experienced Lost of Taste or Smell Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptA2, symptom, "Experienced Appetite Changes Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptA3, symptom, "Experienced Feeling More Tired than Usual Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptA4, symptom, "Experienced Trouble Remembering Things Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptA5, symptom, "Experienced Trouble Paying Attention Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptA6, symptom, "Experienced Trouble Thinking or Making Decisions Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptB1, symptom, "Experienced Shortness of Breath Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptB2, symptom, "Experienced Inability to Exercise at Normal Level Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptB3, symptom, "Experienced Inability to Return to School or Work Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptB4, symptom, "Experienced Inability to Return to Usual Activities Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_symptB5, symptom, "Experienced Feeling Weak, Tired, or Sick after Physical Activity Since COVID-19 Diagnosis",
factor_levels = c("Never Felt", "Previously Felt",  "Currently Feeling", "Skipped this question"))
...
simple_funct(which_sympt1, symptom, "Experienced Feeling Lightheaded or Dizzy Since COVID-19 Diagnosis",
factor_levels = c("Never Felt", "Previously Felt",  "Currently Feeling", "Skipped this question"))
...
simple_funct(which_sympt2, symptom, "Experienced Periods of Racing Heart Rate Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_sympt3, symptom, "Experienced Trouble Sleeping Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_sympt4, symptom, "Experienced Changes to Mood or Emotion Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(which_sympt5, symptom, "Experienced Muscle Aches Since COVID-19 Diagnosis",
factor_levels = c("Never Experienced", "Previously Experienced",  "Currently Experiencing", "Skipped this question"))
...
simple_funct(dt_select2, D_110872086_D_110872086, "Experienced Any Other Symptoms Since COVID-19 Diagnosis",
factor_levels = c("Yes, another",  "No") )



#COV19C6B
one_logic_funct(CVD_tib,D_591826144, D_110872086_D_110872086, "707601969", "Still Experiencing the Other Symptoms Since COVID-19 Diagnosis",
factor_levels = c("Yes",  "No") )
...
two_logic_funct(CVD_tib,D_114280729_D_374567479, "Length of Time Lost of Taste or Smell Experienced", D_847578001_D_488415137, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV20A2
two_logic_funct(CVD_tib,D_114280729_D_966214244, "Length of Time Feeling More Tired Experienced", D_847578001_D_730334054, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A3
two_logic_funct(CVD_tib,D_114280729_D_109223043, "Length of Time Having Trouble Remembering Things", D_847578001_D_215996690, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A4
two_logic_funct(CVD_tib,D_114280729_D_368669706, "Length of Time Having Trouble Paying Attention", D_847578001_D_462737492, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A5
two_logic_funct(CVD_tib,D_114280729_D_605818246, "Length of Time Having Trouble Thinking or Making Decisions", D_847578001_D_469675296, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A6
two_logic_funct(CVD_tib,D_114280729_D_790860504, "Length of Time Appetite Changes Experienced", D_847578001_D_167695804, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A7
two_logic_funct(CVD_tib,D_114280729_D_336856410, "Length of Time Feeling of Lightheadedness or Dizziness Experienced", D_751358419_D_524096053, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A8
two_logic_funct(CVD_tib,D_114280729_D_518602598, "Length of Time Periods of Racing Heart Rate Experienced", D_751358419_D_814101706, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A9
two_logic_funct(CVD_tib,D_114280729_D_770190369, "Length of Time Shortness of Breath Experienced", D_136730307_D_962475128, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A10
two_logic_funct(CVD_tib,D_114280729_D_994153376, "Length of Time Inability to Exercise at Usual Level Experienced", D_136730307_D_989576239, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A11
two_logic_funct(CVD_tib,D_114280729_D_481587023, "Length of Time Inability to Return to Work or School Experienced", D_136730307_D_338613869, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A12
two_logic_funct(CVD_tib,D_114280729_D_590361055, "Length of Time Inability to Return to Work or School Experienced", D_136730307_D_126794793, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A13
two_logic_funct(CVD_tib,D_114280729_D_108389123, "Length of Time Feeling Weak, Tired, or Sick after Physical Exercise Experienced", D_136730307_D_218793117, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A14
two_logic_funct(CVD_tib,D_114280729_D_747085418, "Length of Time Trouble Sleeping Experienced", D_751358419_D_635026188, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A15
two_logic_funct(CVD_tib,D_114280729_D_702905707, "Length of Time Changes in Mood and Emotions Experienced", D_751358419_D_238135048, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A16
two_logic_funct(CVD_tib,D_114280729_D_986119909, "Length of Time Muscle Aches Experienced", D_751358419_D_632714520, "724612102", "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
#COV20A17
one_logic_funct(CVD_tib,D_934384452, D_110872086_D_110872086, "707601969", "Length of Time Other Symptom Experienced",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
#COV21
one_logic_funct(CVD_tib,D_273371161, D_110872086_D_110872086, "707601969", "Feel Like You Have Fully Recovered from COVID-19",
factor_levels = c("Yes", "Yes, mostly", "No"))

#COV22

COV22_Months=hist_funct(CVD_tib,D_959877599_D_700620868, "Time to Fully Recover from COVID-19", "Months", "Count")
COV22_Days=hist_funct(CVD_tib,D_959877599_D_908044428, "Time to Fully Recover from COVID-19", "Days", "Count")
...
simple_funct(which_COV23A1, answer, "Experienced Lost of Taste or Smell Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
simple_funct(which_COV23A2, answer, "Experienced Appetite Changes Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
simple_funct(which_COV23A3, answer, "Feeling More Tired than Usual Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") ) 
...
simple_funct(which_COV23A4, answer, "Having Trouble Remebering Things Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )  
...
which_COV23A5= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
 ...
 simple_funct(which_COV23A5, answer, "Having Trouble Paying Attention Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
which_COV23A6= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
  ...
  simple_funct(which_COV23A6, answer, "Having Trouble Thinking or Making Decisions Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
which_COV23B1= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
   ...
   simple_funct(which_COV23B1, answer, "Felt Dizziness or Shortness of Breath Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
simple_funct(which_COV23B2, answer, "Experienced Periods of Raching of Heart Rate Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
simple_funct(which_COV23B3, answer, "Experienced Shortness of Breath Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") ) 
...
which_COV23B4= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
 ...
 simple_funct(which_COV23B4, answer, "Experienced Feeling Weak, Tired, or Sick after Physical Activity Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") )
...
which_COV23B5= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
 ...
 simple_funct(which_COV23B5, answer, "Having Trouble Sleeping Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") ) 
...
which_COV23B6= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
 ...
 simple_funct(which_COV23B6, answer, "Experienced Changes in Mood or Emotion Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") ) 
...
which_COV23B7= CVD_tib  %>%  filter(D_494226443!="353358909" | D_498462481_1_1=="104430631"| D_694503437_1_1=="104430631") %>%  
  ...
  simple_funct(which_COV23B7, answer, "Experienced Muscle Aches Since 2020",
factor_levels = c("Yes, I am experiencing this now", "Yes, I experienced this in the past", "No, I never experienced this") ) 
...
#COV23B8A
simple_funct(CVD_tib,D_424718457_D_424718457, "Experienced any Other Symptom Since 2020",
factor_levels = c("Yes, another", "No") )
...
#COV238B
one_logic_funct(CVD_tib,D_368715875, D_424718457_D_424718457, "707601969", "Table 126: Still Experiencing Said Other Symptom",
factor_levels = c("Yes", "No"))
...
#GRID
#COV24A1
two_logic_funct(CVD_tib,D_749956170_D_527872064 , "Length of Time Experiencing Loss of Taste or Smell", D_813989715_D_874168085,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A2
two_logic_funct(CVD_tib,D_749956170_D_691752394 , "Length of Time Experiencing Appetite Changes", D_813989715_D_283112988,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A3
two_logic_funct(CVD_tib,D_749956170_D_143206081 , "Length of Time Feeling More Tired Than Usual", D_813989715_D_580629349,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A4
two_logic_funct(CVD_tib,D_749956170_D_431203595 , "Length of Time Having Trouble Remembering Things", D_813989715_D_151327643,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A5
two_logic_funct(CVD_tib,D_749956170_D_516899143 , "Length of Time Having Trouble Paying Attention", D_813989715_D_440872808,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A6
two_logic_funct(CVD_tib,D_749956170_D_223008071 , "Length of Time Having Trouble Thinking or Making Decision", D_813989715_D_874223830,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A7
two_logic_funct(CVD_tib,D_749956170_D_599862694 , "Length of Time Experiencing Feeling Lightheaded and Dizzy", D_857165713_D_847529903,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A8
two_logic_funct(CVD_tib,D_749956170_D_860444009 , "Length of Time Experiencing Periods of Racing Heart Rate", D_857165713_D_219358831,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A9
two_logic_funct(CVD_tib,D_749956170_D_246857412 , "Length of Time Experiencing Shortness of Breath", D_857165713_D_636367178,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A10
two_logic_funct(CVD_tib,D_749956170_D_144819886 , "Length of Time Experiencing Feeling Weak, Tired or Sick after Physical Activity", D_857165713_D_243443780,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A11
two_logic_funct(CVD_tib,D_749956170_D_304155106 , "Length of Time Having Trouble Sleeping", D_857165713_D_357462273,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A12
two_logic_funct(CVD_tib,D_749956170_D_830581863 , "Length of Time Experiencing Changes in your Mood or Emotions", D_857165713_D_638380747,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A13
two_logic_funct(CVD_tib,D_749956170_D_463689026 , "Length of Time Experiencing Muscle Aches", D_857165713_D_187399900,"931688701","586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
CVD_tib <- CVD_tib %>% mutate(D_890156588_V2= ifelse(is.na(D_890156588_V2), D_890156588, D_890156588_V2))
   
simple_funct(CVD_tib,D_890156588_V2, "Received COVID-19 Vaccination",
                   factor_levels = c("Yes", "No", "Do not Know")) 
...
cat("\\FloatBarrier")
hist_funct(CVD_tib,D_877074400_V2, "Number of COVID-19 Vaccinations", "Vaccinations", "Count")
```
...
simple_funct(COV28_1, D_220055064_1_1_D_220055064_1_1, "Brand of First COVID-19 Vaccine") 
...
simple_funct(COV28_2, D_220055064_2_2_D_220055064_2_2, "Brand of Second COVID-19 Vaccine") 
   
   

COV28_3 <- CVD_tib  %>%  filter(vaccinated=="353358909" & (vacc_num>=3)) 

simple_funct(COV28_3, D_220055064_3_3_D_220055064_3_3, "Brand of Third COVID-19 Vaccine")
   
   

COV28_4 <- CVD_tib  %>%  filter(vaccinated=="353358909" & (vacc_num>=4))

simple_funct(COV28_4, D_220055064_4_4_D_220055064_4_4, "Brand of Fourth COVID-19 Vaccine")
   
   

COV28_5 <- CVD_tib  %>%  filter(vaccinated=="353358909" & (vacc_num>=5))

simple_funct(COV28_5, D_220055064_5_5_D_220055064_5_5, "Brand of Fifth COVID-19 Vaccine")
