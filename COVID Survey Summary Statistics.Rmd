...
simple_funct_CVD <- function(data,CID, Title, factor_levels = NULL){  
...
covid_once_funct <- function(CID, Title, factor_levels = NULL){  
  CID_SYM <- rlang::ensym(CID)
...
covid_twice_funct <- function(CID, Title, factor_levels = NULL){  
  CID_SYM <- rlang::ensym(CID)
...
covid_thrice_funct <- function(CID, Title, factor_levels = NULL){  
  CID_SYM <- rlang::ensym(CID)
...
# One filter/skip logic step, with factoring option
one_logic_funct <- function(data,CID, CID_prev, Prev_Answer, Title, factor_levels = NULL){
  CID_SYM <- rlang::ensym(CID)
  CID_SYM_P <- rlang::ensym(CID_prev)

  gt_yn <- data %>%
    filter(!!CID_SYM_P == Prev_Answer) %>%
    group_by(!!CID_SYM) %>%
    summarize(n = n(), percentage = 100 * n / nrow(.)) %>%
    ungroup() %>%
    mutate(answer = dplyr::recode(!!CID_SYM, !!!dict)) %>%
...
# Two filters/skip logic steps, with factoring option
two_logic_funct <- function(data,CID, Title, CID_prev, Prev_Answer1, Prev_Answer2, factor_levels = NULL){
  CID_SYM <- rlang::ensym(CID)
  CID_SYM_P <- rlang::ensym(CID_prev)

  gt_yn <- data %>%
    filter(!!CID_SYM_P == Prev_Answer1 | !!CID_SYM_P == Prev_Answer2) %>%
    group_by(!!CID_SYM) %>%
    summarize(n = n(), percentage = 100 * n / nrow(.)) %>%
    ungroup() %>%
    mutate(answer = dplyr::recode(!!CID_SYM, !!!dict)) %>%
...
create_kable_table <- function(df, group_by_vriable, Title, factor_levels = NULL){  
...
hist_funct <- function(CID,Title, Xlab, Ylab) {
  ...
  CVD_tib %>% 
    dplyr::mutate(!!CID_SYM:=as.numeric(!!CID_SYM),
                  Perc.99 = quantile(!!CID_SYM, 0.99, na.rm=T)) %>%
...
CVD_tib <- CVD_tib %>% mutate(D_860011428_num = case_when(as.numeric(D_860011428)<100 ~ D_860011428,
                                                          TRUE ~ NA))
cov2 <- hist_funct(D_860011428_num, "Times Having COVID-19", "Times", "Frequency")
...
#COV7
one_logic_funct(CVD_tib,D_451163824_1_1, "Worst Symptoms Interfere with Daily Activities the First Time Having COVID-19", D_694503437_1_1, "353358909",
...
#COV9
one_logic_funct(CVD_tib,D_928530823_1_1, "Experience Septic Shock the First Time Having COVID-19", D_694503437_1_1, "353358909",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV10
one_logic_funct(CVD_tib,D_108733102_1_1, "Diagnosed with Pneumonia the First Time Having COVID-19", D_694503437_1_1, "353358909",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV11
one_logic_funct(CVD_tib,D_389465772_1_1, "Diagnosed with Bood Clots the First Time Having COVID-19", D_694503437_1_1, "353358909",
                   factor_levels = c("Yes", "No", "Do not Know"))


#COV12
one_logic_funct(CVD_tib,D_775313030_1_1, "Overnight Hospital Stay the First Time Having COVID-19", D_694503437_1_1, "353358909",
                   factor_levels = c("Yes", "No", "Do not Know"))
...
#COV14A
one_logic_funct(CVD_tib,D_782396371_1_1, "Given Oxygen in the Hospital the First Time Having COVID-19", D_775313030_1_1, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV15A
one_logic_funct(CVD_tib,D_984121390_1_1, "Given Breathing Tube or Ventilator in the Hospital the First Time Having COVID-19", D_775313030_1_1, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV16A
one_logic_funct(CVD_tib,D_179406442_1_1, "ICU monitoring in the Hospital the First Time Having COVID-19", D_775313030_1_1, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV17A
one_logic_funct(CVD_tib,D_893966847_1_1, "Receive Dialysis Treatment in the Hospital the First Time Having COVID-19", D_775313030_1_1, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV7
one_logic_funct(CVD_tib,D_451163824_2_2, "Worst Symptoms Interfere with Daily Activities the Second Time Having COVID-19", D_694503437_2_2, "353358909",
               factor_levels = c("Not at all",
                  "A little bit", "Somewhat", "Quite a bit", "Very Much"))
...
#COV9
one_logic_funct(CVD_tib,D_928530823_2_2, "Experience Septic Shock the Second Time Having COVID-19", D_694503437_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))

#COV10
one_logic_funct(CVD_tib,D_108733102_2_2, "Diagnosed with Pneumonia the Second Time Having COVID-19", D_694503437_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))

#COV11
one_logic_funct(CVD_tib,D_389465772_2_2, "Diagnosed with Bood Clots the Second Time Having COVID-19", D_694503437_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))

#COV12
one_logic_funct(CVD_tib,D_775313030_2_2, "Overnight Hospital Stay the Second Time Having COVID-19", D_694503437_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV14A
one_logic_funct(CVD_tib,D_782396371_2_2, "Given Oxygen in the Hospital the Second Time Having COVID-19", D_775313030_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV15A
one_logic_funct(CVD_tib,D_984121390_2_2, "Given Breathing Tube or Ventilator in the Hospital the Second Time Having COVID-19", D_775313030_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV16A
one_logic_funct(CVD_tib,D_179406442_2_2, "ICU monitoring in the Hospital the Second Time Having COVID-19", D_775313030_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV17A
one_logic_funct(CVD_tib,D_893966847_2_2, "Receive Dialysis Treatment in the Hospital the Second Time Having COVID-19", D_775313030_2_2, "353358909",
factor_levels = c("Yes", "No", "Do not Know"))
...
#COV19C6B
one_logic_funct(CVD_tib,D_591826144, "Still Experiencing the Other Symptoms Since COVID-19 Diagnosis", D_110872086_D_110872086, "707601969",
factor_levels = c("Yes",  "No") )
...
two_logic_funct(CVD_tib,D_114280729_D_374567479, "Length of Time Lost of Taste or Smell Experienced", D_847578001_D_488415137, "724612102", D_847578001_D_488415137, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV20A2
two_logic_funct(CVD_tib,D_114280729_D_966214244, "Length of Time Feeling More Tired Experienced", D_847578001_D_730334054, "724612102", D_847578001_D_730334054, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A3
two_logic_funct(CVD_tib,D_114280729_D_109223043, "Length of Time Having Trouble Remembering Things", D_847578001_D_215996690, "724612102", D_847578001_D_215996690, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A4
two_logic_funct(CVD_tib,D_114280729_D_368669706, "Length of Time Having Trouble Paying Attention", D_847578001_D_462737492, "724612102", D_847578001_D_462737492, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A5
two_logic_funct(CVD_tib,D_114280729_D_605818246, "Length of Time Having Trouble Thinking or Making Decisions", D_847578001_D_469675296, "724612102", D_847578001_D_469675296, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A6
two_logic_funct(CVD_tib,D_114280729_D_790860504, "Length of Time Appetite Changes Experienced", D_847578001_D_167695804, "724612102", D_847578001_D_167695804, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A7
two_logic_funct(CVD_tib,D_114280729_D_336856410, "Length of Time Feeling of Lightheadedness or Dizziness Experienced", D_751358419_D_524096053, "724612102", D_751358419_D_524096053, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A8
two_logic_funct(CVD_tib,D_114280729_D_518602598, "Length of Time Periods of Racing Heart Rate Experienced", D_751358419_D_814101706, "724612102", D_751358419_D_814101706, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A9
two_logic_funct(CVD_tib,D_114280729_D_770190369, "Length of Time Shortness of Breath Experienced", D_136730307_D_962475128, "724612102", D_136730307_D_962475128, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A10
two_logic_funct(CVD_tib,D_114280729_D_994153376, "Length of Time Inability to Exercise at Usual Level Experienced", D_136730307_D_989576239, "724612102", D_136730307_D_989576239, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A11
two_logic_funct(CVD_tib,D_114280729_D_481587023, "Length of Time Inability to Return to Work or School Experienced", D_136730307_D_338613869, "724612102", D_136730307_D_338613869, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A12
two_logic_funct(CVD_tib,D_114280729_D_590361055, "Length of Time Inability to Return to Work or School Experienced", D_136730307_D_126794793, "724612102", D_136730307_D_126794793, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A13
two_logic_funct(CVD_tib,D_114280729_D_108389123, "Length of Time Feeling Weak, Tired, or Sick after Physical Exercise Experienced", D_136730307_D_218793117, "724612102", D_136730307_D_218793117, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A14
two_logic_funct(CVD_tib,D_114280729_D_747085418, "Length of Time Trouble Sleeping Experienced", D_751358419_D_635026188, "724612102", D_751358419_D_635026188, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A15
two_logic_funct(CVD_tib,D_114280729_D_702905707, "Length of Time Changes in Mood and Emotions Experienced", D_751358419_D_238135048, "724612102", D_751358419_D_238135048, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))

#COV20A16
two_logic_funct(CVD_tib,D_114280729_D_986119909, "Length of Time Muscle Aches Experienced", D_751358419_D_632714520, "724612102", D_751358419_D_632714520, "178780048",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
#COV20A17
one_logic_funct(CVD_tib,D_934384452, "Length of Time Other Symptom Experienced", D_110872086_D_110872086, "707601969",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
#COV21
one_logic_funct(CVD_tib,D_273371161, "Feel Like You Have Fully Recovered from COVID-19", D_110872086_D_110872086, "707601969",
...
#COV238B
one_logic_funct(CVD_tib,D_368715875, "Table 126: Still Experiencing Said Other Symptom", D_424718457_D_424718457, "707601969",
factor_levels = c("Yes", "No"))
...
#GRID
#COV24A1
two_logic_funct(CVD_tib,D_749956170_D_527872064 , "Length of Time Experiencing Loss of Taste or Smell", D_813989715_D_874168085,"931688701",D_813989715_D_874168085,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A2
two_logic_funct(CVD_tib,D_749956170_D_691752394 , "Length of Time Experiencing Appetite Changes", D_813989715_D_283112988,"931688701",D_813989715_D_283112988,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A3
two_logic_funct(CVD_tib,D_749956170_D_143206081 , "Length of Time Feeling More Tired Than Usual", D_813989715_D_580629349,"931688701",D_813989715_D_580629349,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A4
two_logic_funct(CVD_tib,D_749956170_D_431203595 , "Length of Time Having Trouble Remembering Things", D_813989715_D_151327643,"931688701",D_813989715_D_151327643,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A5
two_logic_funct(CVD_tib,D_749956170_D_516899143 , "Length of Time Having Trouble Paying Attention", D_813989715_D_440872808,"931688701",D_813989715_D_440872808,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A6
two_logic_funct(CVD_tib,D_749956170_D_223008071 , "Length of Time Having Trouble Thinking or Making Decision", D_813989715_D_874223830,"931688701",D_813989715_D_874223830,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A7
two_logic_funct(CVD_tib,D_749956170_D_599862694 , "Length of Time Experiencing Feeling Lightheaded and Dizzy", D_857165713_D_847529903,"931688701",D_857165713_D_847529903,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A8
two_logic_funct(CVD_tib,D_749956170_D_860444009 , "Length of Time Experiencing Periods of Racing Heart Rate", D_857165713_D_219358831,"931688701",D_857165713_D_219358831,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A9
two_logic_funct(CVD_tib,D_749956170_D_246857412 , "Length of Time Experiencing Shortness of Breath", D_857165713_D_636367178,"931688701",D_857165713_D_636367178,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A10
two_logic_funct(CVD_tib,D_749956170_D_144819886 , "Length of Time Experiencing Feeling Weak, Tired or Sick after Physical Activity", D_857165713_D_243443780,"931688701",D_857165713_D_243443780,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))


#COV24A11
two_logic_funct(CVD_tib,D_749956170_D_304155106 , "Length of Time Having Trouble Sleeping", D_857165713_D_357462273,"931688701",D_857165713_D_357462273,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A12
two_logic_funct(CVD_tib,D_749956170_D_830581863 , "Length of Time Experiencing Changes in your Mood or Emotions", D_857165713_D_638380747,"931688701",D_857165713_D_638380747,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))



#COV24A13
two_logic_funct(CVD_tib,D_749956170_D_463689026 , "Length of Time Experiencing Muscle Aches", D_857165713_D_187399900,"931688701",D_857165713_D_187399900,"586272115",
               factor_levels = c("Less than 1 month", "Between 1 and 3 months", "More than 3 months"))
...
create_kable_table(CVD_tib,D_890156588_V2, "Received COVID-19 Vaccination",
                   factor_levels = c("Yes", "No", "Do not Know")) 
