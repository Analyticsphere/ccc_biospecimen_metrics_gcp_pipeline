...
#View(box1)
write.csv(box1,paste("Formatted_prod_flatBoxes_JP_",currentDate,"_boxfolder_221280601453",".csv",sep=""),row.names = F,na="")
...
write.csv(biospe1_fin,paste("Connect_prod_Biospe_Formats_",currentDate,"_boxfolder_221280601453",".csv",sep=""),row.names = F,na="")
...
write.csv(recrbio1,paste("Connect_prod_recr_veriBiospe_Formats_",currentDate,"_boxfolder_221280601453",".csv",sep=""),row.names = F,na="")
...
write.csv(coordination,paste("Biospecimen_Coordinating_Table_One_",currentDate,"_boxfolder_221280601453",".csv",sep=""),row.names = F,na="")
...
write.csv(box_table2,paste("Biospecimen_Coordinating_Table_Two_",currentDate,"_boxfolder_221280601453",".csv",sep=""),row.names = F,na="")
