...
recrver1 <- recrver1 %>%  mutate(Clin_Site_location=case_when(
                                  ...
                                  #Site=="University of Chicago Medicine" & (d_173836415_d_266600170_d_185243482==25 | d_173836415_d_266600170_d_452847912==25) ~ "DCAM",
                                  #Site=="University of Chicago Medicine" & (d_173836415_d_266600170_d_185243482==25 | d_173836415_d_266600170_d_452847912==25) ~ "Harvey",
...
tabl27 <- knitr::kable(verif_draw_order,
                       ...
                       row.names=FALSE, align=c("l","c","c","c"),digits=1, booktabs = TRUE)  %>% 
  kable_styling(latex_options = "scale_down")
