...
biospe <- bq_table_download(bio_tb,bigint="integer64",n_max = Inf, page_size = 5000)
cnames <- names(biospe)
...
avg <- bq_table_download(avg_table_cc, bigint="integer64",n_max = Inf, page_size = 10000)
...
collTS <- bq_table_download(TSofcollection_cc, bigint="integer64",n_max = Inf, page_size = 5000)
...
biospe2 <- bq_table_download(bio_tb2,bigint="integer64",n_max = Inf, page_size = 5000)
