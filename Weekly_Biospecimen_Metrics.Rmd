...
test30 <- kit_table %>%
  filter(Kit_Status_int=="Received" & !is.na(d_173836415_d_266600170_d_319972665_d_826941471) &
...
Table7.4 <- bind_rows(Table7.4, total_row)
...
Table7.5 <- bind_rows(Table7.5, total_row)
...
table7.4 <- knitr::kable(Table7.4,
                         ...
                         row.names=FALSE, align=c("l", rep("c", 8)),digits=1, booktabs = TRUE) %>% 
  add_indent(seq(1, nrow(Table7.4) - 1)) %>% 
  kable_styling(latex_options = "HOLD_position")
 
add_footnote(table7.4, "Note: Kits were returned using USPS prior to 6/17/2024.", notation = "none")


## Pending approval-- new table 7.5
pending_TD <- knitr::kable(Shipped_TD,
...
knitr::kable(Table7.5,
  ...
  add_indent(seq(1, nrow(Table7.5) - 1)) %>% 
  kable_styling(latex_options = "HOLD_position")
...
tbl_7_9 <- knitr::kable(table7_9_totals,
                        caption = "Table 7.8: Baseline- Mouthwash Biospecimen Survey Completion Time Relative to Collection Time Reported on \n Collection Card of the First Received Mouthwash Kit ",
