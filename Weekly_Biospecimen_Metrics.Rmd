...
biospe7= left7  %>%
  ...
  filter((d_173836415_d_266600170_d_185243482==1050010095 | d_173836415_d_266600170_d_185243482==1060010063 & d_173836415_d_266600170_d_185243482==1060170018 | d_173836415_d_266600170_d_185243482==1040010047 | d_173836415_d_266600170_d_185243482==1011410008 | d_173836415_d_266600170_d_185243482==1010180040 | d_173836415_d_266600170_d_185243482==1010120026 | d_173836415_d_266600170_d_185243482==1010240013 | d_173836415_d_266600170_d_185243482==1011220006 | d_173836415_d_266600170_d_185243482==1010360011 | d_173836415_d_266600170_d_185243482==1010010193) & !is.na(d_173836415_d_266600170_d_185243482)) %>% #HP keeps sending unspecified location codes, need to old use currently known locations until hold the names of the new locations
  mutate(HF_Sites= case_when(d_173836415_d_266600170_d_185243482==1050010095 ~ "Wyandotte Hospital",
                                       ...
                                       d_173836415_d_266600170_d_185243482==1040010047 ~ "West Bloomfield Hospital",
                             ...
                             #d_173836415_d_266600170_d_185243482==1040010046 ~ "Unknown",
                                       d_173836415_d_266600170_d_185243482==1010010193 ~ "Main - K1"))   
#biospe7$HF_Sites<- droplevels(biospe7$HF_Sites)
...
bldcol_research_HF2 <- bldcol_research_HF2[, c(7:10,3)] # RIGHT NOW THERE IS AN NA LOCATION FOR SOME REASON
```
...
newtable4[,2] <- c(dash_bloodP, site_dash_bloodP, site_bloodP, total_bloodP)
newtable4[,3] <- c(dash_urineP, site_dash_urineP,  site_urineP, total_urineP)
#newtable4[4,] <- list('Total', total_bloodP, total_urineP)
colnames(newtable4) <- c(md("Data System"), md("Blood"), md("Urine"))
```
...
##Table 17
recr.biospe <- base::merge(recr.bio,tube_col,by="Connect_ID")
...
clc_both_vt.site.CO<-ggplot(clc.both.wk_site.CO, aes(x=as_date(ymd(visit.wkdate)), y=n)) + #,fill=Site, color=Site)) +
  ...
  scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)),expand=c(0,0))  +
  scale_fill_brewer(palette="Dark2") + 
...
research.4_1 <- ggplot(visit_wk_site4__1, aes(x=as.Date(visit.wkdate), y=100*(hours3/n))) + #, color=Site)) + #,fill=Site, color=Site)) +
...
fig4_sub_1$visit.wkdate <- fig4_sub_1$start.date + dweeks(fig4_sub_1$visit.wk)
visit_wk_site4 <- fig4_sub_1 %>% arrange(Site,hours3,visit.wk,visit.wkdate) %>% group_by(Site,hours3,visit.wk,visit.wkdate) %>% tally()
visit_wk_site4__2 <- visit_wk_site4 %>%  filter(hours3>0)


research.4_2 <- ggplot(visit_wk_site4__2, aes(x=as.Date(visit.wkdate), y=100*(hours3/n))) + #, color=Site)) + #,fill=Site, color=Site)) +
  geom_line() + geom_point(width = 0.2) +
  scale_y_continuous(name="Percent",breaks=seq(0,100,25)) +
  scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)),expand=c(0,0))  +
  scale_fill_brewer(palette="Dark2") +
...
research.4_3 <- ggplot(visit_wk_site4__3, aes(x=as.Date(visit.wkdate), y=100*(hours3/n))) + #, color=Site)) + #,fill=Site, color=Site)) +
  geom_line() + geom_point(width = 0.2) +
  scale_y_continuous(name="Percent",breaks=seq(0,100,25)) +
  scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)),expand=c(0,0))  +
  scale_fill_brewer(palette="Dark2") +
...
```{r KnitrTables1_5, eval=TRUE,echo=FALSE}
options(knitr.table.format = "latex")
...
Bld_urn_cli = knitr::kable(newtable4, caption='Table 4. Data System Status Among Baseline Clinical Collections by Specimen Type', row.names=FALSE,align=c("l","c","c"), booktabs = TRUE) %>%  kable_styling(latex_options = "scale_down") 
...
help_fig1 <- fig1_UC_inc %>% select(visit.wkdate, bld.complt) %>%  # %>%  filter(bld.complt=="BloodIncomplet" | bld.complt=="NoBlood")
...
help2_1_fig1 <- help_fig1 %>%  group_by(visit.wkdate,  partial_blood, no_blood, all_blood) #%>%  tally() 

help2_1_fig1 <- help2_1_fig1 %>%  mutate(incomp_blood = case_when( (partial_blood==1 |no_blood==1) ~1,
                                                                  TRUE ~ 0))

help2_1_fig1_inc <- help2_1_fig1 %>%  select(visit.wkdate,  partial_blood, no_blood, all_blood, incomp_blood) %>%  group_by(visit.wkdate)


final_fig1_table <- help2_1_fig1_inc %>%  group_by(visit.wkdate) %>%  summarize( incomplete=sum(incomp_blood),
...
research.1_1 <- ggplot() + #, color=UC_Sites) + #,fill=Site, color=Site)) +
  geom_line(data=final_fig1_table, aes(x=as.Date(visit.wkdate), y=All_Incomplete, colour="All_Incomplete"),na.rm=T) +
  geom_line(data=final_fig1_table, aes(x=as.Date(visit.wkdate), y=Partial__Blood, colour="Partial__Blood"), na.rm=T) +
  geom_line(data=final_fig1_table, aes(x=as.Date(visit.wkdate), y=No__Blood, colour="No__Blood"), na.rm=T) +
  geom_point(width = 0.2) +
...
help_fig2 <- fig2_HF_inc %>% select(visit.wkdate, bld.complt) %>%  # %>%  filter(bld.complt=="BloodIncomplet" | bld.complt=="NoBlood")
  mutate(#incomp_blood = case_when(bld.complt=="BloodIncomplet"~"Partial Blood",
                                  #bld.complt=="NoBlood" ~"No Blood"))
          partial_blood= case_when(bld.complt=="BloodIncomplet"~1,
                             TRUE ~0),
...
help2_1_fig2 <- help_fig2 %>%  group_by(visit.wkdate,  partial_blood, no_blood, all_blood) #%>%  tally() 

help2_1_fig2 <- help2_1_fig2 %>%  mutate(incomp_blood = case_when( (partial_blood==1 |no_blood==1) ~1,
                                                                  TRUE ~ 0))

help2_1_fig2_inc <- help2_1_fig2 %>%  select(visit.wkdate,  partial_blood, no_blood, all_blood, incomp_blood) %>%  group_by(visit.wkdate)

final_fig2_table <- help2_1_fig2_inc %>%  group_by(visit.wkdate) %>%  summarize( incomplete=sum(incomp_blood),
  partial=sum(partial_blood), none_blood=sum(no_blood), all_collections=sum(all_blood),  All_Incomplete=100*(incomplete/all_collections),
  Partial__Blood=100*(partial/all_collections),  No__Blood=100*(none_blood/all_collections))
...
research.1_2 <- ggplot() + #, color=UC_Sites) + #,fill=Site, color=Site)) +
  geom_line(data=final_fig2_table, aes(x=as.Date(visit.wkdate), y=All_Incomplete, colour="All_Incomplete"),na.rm=T) +
  geom_line(data=final_fig2_table, aes(x=as.Date(visit.wkdate), y=Partial__Blood, colour="Partial__Blood"), na.rm=T) +
  geom_line(data=final_fig2_table, aes(x=as.Date(visit.wkdate), y=No__Blood, colour="No__Blood"), na.rm=T) +
  geom_point(width = 0.2) +
  scale_y_continuous(name="Percent", limits=c(0,100),expand = c(0, 0), breaks=seq(0,100,25)) +
  scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)) ,expand=c(0,0))  +
  scale_fill_brewer(palette="Dark2") +
...
tab8=knitr::kable(notcol_combo2,caption='Table 10. Blood Tubes Collected by Tube Type at Clinical Collections', row.names=FALSE,align=c("l","c","c","c","c","c","c","c","c","c","c","c"), booktabs = TRUE) %>%  kable_styling(latex_options = "scale_down") %>% landscape()
...
figsub3 <- fig3_sub %>% arrange(visit.wkdate,research.sv) %>% group_by(visit.wkdate,research.sv) %>% tally()

figsub3_2 <- figsub3 %>% group_by(visit.wkdate) %>% mutate(per_week_parts=sum(n))

figsub3_3 <- figsub3_2 %>% group_by(visit.wkdate) %>% filter(research.sv!="Submitted" & research.sv!="Started") %>%  mutate(weekly_notsub=n)

figsub3_4 <- figsub3_3 %>% group_by(visit.wkdate) %>%  filter(research.sv!="Submitted" & research.sv!="Started") %>%  select(visit.wkdate,research.sv,weekly_notsub, per_week_parts)
...
research.3 <- ggplot(figsub3_5, aes(x=as.Date(visit.wkdate), y=100*(cum_notsub/cumtotal))) + #, color=Site)) + #,fill=Site, color=Site)) +
...
```{r Fig6, eval=TRUE,echo=FALSE,fig.cap='Figure 2'}
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
...
#- SANFORD = 589224449, 467088902
 ...
 research.vt_plUC <- research.vt_plUC %>% group_by(visit.wkdate) %>% mutate(total_collections = sum(n))
 research.vt_plotUC <- ggplot(research.vt_plUC, aes(x=as.Date(visit.wkdate), y=total_collections)) + #,fill=site, color=site)) +   #research.vt <-    ,fill=Site, color=Site
   geom_line() + geom_point(width = 0.2) +
   scale_y_continuous(name="# Number Collections") +
   scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)),expand=c(0,0))  +
   scale_fill_brewer(palette="Dark2") +
 ...
 research.vt_plMF <- research.vt_plMF %>% group_by(visit.wkdate) %>% mutate(total_collections = sum(n))
 
 research.vt_plotMF <- ggplot(research.vt_plMF, aes(x=as.Date(visit.wkdate), y=total_collections)) + #,fill=site, color=site)) +   #research.vt <-    ,fill=Site, color=Site
   geom_line() + geom_point(width = 0.2) +
   scale_y_continuous(name="# Number Collections") +
   scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", limits=c( as.Date("2022-06-20"),as.Date(Sys.Date() - 7)),expand=c(0,0))  +
   scale_fill_brewer(palette="Dark2") +
