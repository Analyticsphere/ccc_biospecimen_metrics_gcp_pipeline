...
biospe7= left7  %>%
  ...
  mutate(HF_Sites= case_when(d_173836415_d_266600170_d_185243482==1050010095 ~ "Wyandotte Hospital",
                                       d_173836415_d_266600170_d_185243482==1060010063 | d_173836415_d_266600170_d_185243482==1060170018 ~ "Macomb Medical Pavilion",
                                       d_173836415_d_266600170_d_185243482==1040010047 | d_173836415_d_266600170_d_185243482==1040010046 ~ "West Bloomfield Hospital",
                                       d_173836415_d_266600170_d_185243482==1011410008 ~ "Royal Oak",
                                       d_173836415_d_266600170_d_185243482==1010180040 ~ "Fairlane (Dearborn)",
                                       d_173836415_d_266600170_d_185243482==1010120026 ~ "Novi",
                                       d_173836415_d_266600170_d_185243482==1010240013 ~ "Plymouth",
...
add_footnote(Bld_urn_cli, "Note: Data sent by sites experience an availablility delay of up to 48 hours behind data from the Biospecimen Dashboard. Note: Data sent by sites experience an availability delay of up to 48 hours behind data from the Biospecimen Dashboard. 'Site Data Only' is assumed to have a value of '0(0%)' when not listed in this table.", notation = "none")
...
add_footnote(tab8, "Note: Expected number of collection tubes for each Kaiser Permanente site is as follows: (1)KPCO: 4 SST, 2 Heparin, 2 EDTA. (2)KPGA: 4 SST, 1 Heparin, 2 EDTA. (3)KPHI: 4 SST, 2 Heparin, 3 EDTA. (4)KPNW: 5 SST, 2 Heparin, 2 EDTA. (5)HFH: 2 SST, 1 Heparin, 1 EDTA, 1 ACD", notation = "none") 
...
add_footnote(BSL_A,"Note: Note: Baseline Clinical Collections were launched in February 2023.", notation = "none")
...
add_footnote(BSL_B,"Note: Note: Baseline Clinical Collections were launched in February 2023.", notation = "none")
