...
### specifically for Henry Ford--- RESEARCH SITES
...
```{r Table_new_7.2, include=FALSE, echo=FALSE, warning=FALSE}
#,results='hold'

# allshipped <- as.data.frame(table(table27_elg_distinct$Site[!is.na(table27_elg_distinct$d_173836415_d_266600170_d_319972665_d_661940160)]))
...
# #all_shipped <- merge(allshipped, all_recvd, by = "Var1", suffixes = c("_shipped", "_recvd"))
# 
# all_shipped <- merge(allshipped, all_recvd, by.x = "Var1", by.y = "Var1", suffixes = c("_shipped", "_recvd"))
...
# test7.2 <- table(table27_elg_distinct$Site, table27_elg_distinct$Kit_Status)
# test_7.2 <- test7.2[,c(4,5)]
# test_7.2[,3] <- 
...
\FloatBarrier
```{r KnitrTables7.2,eval=TRUE,echo=FALSE,results='asis'}
...
\FloatBarrier
```{r KnitrTables7.3,eval=TRUE,echo=FALSE,results='asis'}
...
\FloatBarrier
```{r KnitrTables7.4_7.6,eval=TRUE,echo=FALSE,results='asis'}
