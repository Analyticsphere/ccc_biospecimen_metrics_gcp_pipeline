...
#d_173836415_d_266600170_d_319972665_d_638781731, d_173836415_d_266600170_d_319972665_d_759651991
# ### Request a kit table 1
#  req_kit <- kit_table %>% filter(d_173836415_d_266600170_d_319972665_d_638781731=="353358909") %>% 
#   mutate(Kit_Status_int = factor(Kit_Status_int,
#                                  levels=c("Undeliverable","Initialized", 
#                                           "Address Printed", "Assigned", "Shipped", "Received")),
#          elg = case_when(is.na(d_173836415_d_266600170_d_319972665_d_759651991) ~ "Ineligible",
#                          TRUE~ "Eligible"),
#          elg = factor(elg,levels=c("Eligible","Ineligible"))) 
# 
# 
# req_kit_table1 <- create_tbl_cross(req_kit, "Site", "Kit_Status_int", "row", "Site", "Kit Status")
# colnames(req_kit_table1)[ncol(req_kit_table1)] <- "Total Kits Requested"
# 
...
# req_kit2 <- req_kit %>% filter(elg=="Eligible")
# 
# req_kit_table2 <- create_tbl_cross(req_kit2, "Site", "Kit_Status_int", "row", "Site", "Kit Status")
