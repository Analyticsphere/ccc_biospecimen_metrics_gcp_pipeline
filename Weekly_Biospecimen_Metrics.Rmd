...
biospe.bld <- knitr::kable(table2_totals ,col.names=c("Site", "Any Baseline \n Blood Collected","No Baseline \n Blood Collected", "Total Baseline \n Collections"), caption='Table 1.5: Baseline Blood Collection Status Among Biospecimen Collections', row.names=FALSE,align=c("l","c","c","c"), booktabs = TRUE)  %>% kable_styling(latex_options = "scale_down")
...
\FloatBarrier
```{r KnitrTables1.4, eval=TRUE,echo=FALSE,results='asis'}
...
```{r KnitrTables1.5, eval=TRUE,echo=FALSE,results='asis'}
biospe.bld %>% kable_styling(latex_options = "scale_down")
```

```{r KnitrTables1.6_1.11, eval=TRUE,echo=FALSE,results='asis'}
...
```{r AdHoc1, eval=TRUE,echo=FALSE, warning=FALSE}
