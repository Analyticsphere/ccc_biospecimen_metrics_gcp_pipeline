...
blood_placed= blood_fig4 %>%  filter(recr.bio$d_821247024==197316935  & (d_827220437==125001209 | d_827220437==327912200 |
                                                                        d_827220437==300267574 | d_827220437==452412599 ))
...
bldorder_present <- recrver1 %>%  filter(d_878865966==104430631 & !is.na(d_173836415_d_266600170_d_769615780) & Site!='HealthPartners' & Site!='Henry Ford Health System') %>%  
...
tab10_2= knitr::kable(tube_completeness_totals, caption='Table 2.9: Baseline- Total Blood Tubes Collected Among Clinical Biospecimen Collections', row.names=FALSE,align=c("l","c","c","c","c","c","c","c","c","c", "c"), booktabs = TRUE) %>%  add_indent(c(1:6))  %>% kable_styling(latex_options = "scale_down")
...
add_footnote(tabe2_12,"Note: T h e ’ S h o r t D r a w ’ is applicable to blood collection tubes only.", notation="none")
