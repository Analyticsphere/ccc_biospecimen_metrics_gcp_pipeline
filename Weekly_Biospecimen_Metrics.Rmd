...
col_num_1.1 <- col_num_1.1 %>%
  mutate(Site_Group = case_when(
    ...
    `Collection Location` %in% c("HFH K-13 Research Clinic", "HFH Livonia Research Clinic", "HFH Cancer Pavilion Research Clinic", "HFH Pop-Up", "HFH Detroit Northwest", "Missing HFH location") ~ "Henry Ford Health",
...
coll_bptl_diff <- biospe_adhoc_all %>%  
  ...
  mutate(Site_location = factor(Site_location,
                                levels=c("BCC- HWC","FW All Saints","BCC- Plano","BCC- Worth St","BCC- Irving",
                                         ...
                                         "HFH Livonia Research Clinic", "HFH Pop-Up", "HFH Detroit Northwest", "Missing HFH location",
