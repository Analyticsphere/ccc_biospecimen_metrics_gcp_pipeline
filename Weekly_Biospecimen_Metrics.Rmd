...
write.csv(recrbio1,glue("{local_drive}Connect_prod_recr_veriBiospe_Formats_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
...
BL_Coll <- bq_table_download(SMMet,bigint = "integer64",n_max = Inf, page_size = 10000)
...
# write.csv(coordination,paste(local_drive, "Biospecimen_Coordinating_Table_One",currentDate,".csv",sep="_"),row.names = F,na="")
write.csv(coordination,glue("{local_drive}Biospecimen_Coordinating_Table_One_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
...
# write.csv(box_table2,paste(local_drive, "Biospecimen_Coordinating_Table_Two",currentDate,".csv",sep="_"),row.names = F,na="")
write.csv(box_table2,glue("{local_drive}Biospecimen_Coordinating_Table_Two_{currentDate}_boxfolder_{boxfolder}.csv"),row.names = F,na="")
