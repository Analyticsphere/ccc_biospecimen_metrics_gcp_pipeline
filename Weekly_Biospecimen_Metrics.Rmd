...
recrver1$BioCol_BldOrderPlaced_v1r0 <- factor(recrver1$d_173836415_d_266600170_d_530173840,exclude=NULL) 




recrver1$BL_BioSpm_MWSetting_v1r0 <- factor(recrver1$d_173836415_d_266600170_d_915179629,levels=c("Clinical","Research","Home"))  
recrver1$BL_BioCol_UrineSetting_v1r0 <- factor(recrver1$d_173836415_d_266600170_d_718172863, levels=c("Clinical","Research","Home"))  
recrver1$BL_BioCol_BloodSetting_v1r0 <- factor(recrver1$d_173836415_d_266600170_d_592099155,levels=c("Clinical","Research","Home"))  
...
## Clinical locations use d_173836415_d_266600170_d_185243482 (BioCol_SiteBldLocBL_v1r0) and d_173836415_d_266600170_d_452847912 (BioCol_SiteUrLocatBL_v1r0) for Site location. 
...
coll_sett_all <- table1 %>%  filter(BiospeCollection == "Any biospecimen Collections" & (d_410912345== 353358909 | BL_BioSpm_MWSetting_v1r0=="Home")) %>% 
  mutate(all_settings = case_when((d_650516960=="664882224" | BL_BioCol_BloodSetting_v1r0=="Clinical" | 
                                    BL_BioCol_UrineSetting_v1r0=="Clinical") ~ "Clinical",
                                  (d_650516960=="534621077" | BL_BioCol_BloodSetting_v1r0=="Research" | 
                                    BL_BioCol_UrineSetting_v1r0=="Research" | BL_BioSpm_MWSetting_v1r0=="Research")~ "Research",
                                  (d_650516960=="103209024" | BL_BioCol_BloodSetting_v1r0=="Home" | 
                                    BL_BioCol_UrineSetting_v1r0=="Home" | BL_BioSpm_MWSetting_v1r0=="Home") ~ "Home"))
...
#### Update from Erin: 
# BioCol_BldOrderPlaced_v1r0 is yes OR NO it means the order had originally been placed.
# (BioCol_BldOrderPlaced_v1r0 is no the order was originally placed and later canceled.) 
# BioCol_BldOrderPlaced_v1r0= null means it has not yet been placed.

Table_bld_draw= table1 %>%  filter(grepl("^Kaiser", Site)) %>% ## excluding hybrid sites
  mutate(Site = droplevels(Site),
         bld_placed= case_when((BioCol_BldOrderPlaced_v1r0=="Yes" | 
                                  BioCol_BldOrderPlaced_v1r0=="No") ~ "Blood Draw Order Placed",
