...
verif_draw <- ver_draw %>%  mutate(time = as.numeric(difftime(ymd_hms(d_173836415_d_266600170_d_769615780),ymd_hms(d_914594314),units="days")))
...
verif_BL_Af <- coll_sett_all %>%  filter(d_331584571== 266600170 & !is.na(d_914594314) & !is.na(d_556788178) & d_914594314>=as.Date("2022-06-01")) %>%  
  mutate(time = as.numeric(difftime(ymd_hms(d_556788178),ymd_hms(d_914594314),units="days")),
...
#IRB_demo_BioCols        # pending approval
