...
#New Table 21- length of time for research survey completion (8/16/23 request) before and after covid
...
##New Table 22- length of time for clinical survey completion (8/16/23 request) before and after covid : start 534669573, finish 764863765
...
verif_baseline_26_Af = BSL_after24 %>%group_by(Site) %>% 
...
verif_baseline_26_Af <- verif_baseline_26_Af %>%  select(Site,  'Number of Baseline Collections1', Min1, Median1, Mean1, SD1, Max1, 'Number of Baseline Collections2', Min2, Median2, Mean2, SD2, Max2, 'Total Number of Baseline Collections')
...
## Table 29 (used to be 23)
Table29_bld_draw <- blood_placed %>% dplyr::select(KP_Site, bld_placed)  %>% tbl_cross(
  row = KP_Site,
  col = bld_placed,
  percent = "row",
  digits=c(0,1),
  ...
  #italicize_levels() %>% 
  modify_header() %>%
  modify_caption("Table 29. Clinical Blood Draw Order Status Among Verified Participants") %>%
  as_kable_extra(escape = FALSE, addtl_fmt = TRUE)
...
tab21_rb=knitr::kable(Table21R_Before,caption='Table 21a. Research Biospecimen Survey Completion Length (in Minutes) by Site (Pre-COVID-19 Questions Removal)',row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down")
...
tab21_ra=knitr::kable(Table21R_After,caption='Table 21b. Research Biospecimen Survey Completion Length (in Minutes) by Site (Post-COVID-19 Questions Removal)',row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down")
...
tab21_cb=knitr::kable(Table22C_Before,caption='Table 22a. Clinical Biospecimen Survey Completion Length (in Minutes) by Site (Pre-COVID-19 Questions Removal)',row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down")
...
tab21_ca=knitr::kable(Table22C_After,caption='Table 22b. Clinical Biospecimen Survey Completion Length (in Minutes) by Site (Post-COVID-19 Questions Removal)',row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down")
...
tab23=knitr::kable(research.vt.length,caption='Table 23. Research Biospecimen Collection Visit Length (in Minutes) by Site',row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down") #%>% landscape()
...
tabbA <- knitr::kable(verif_BSL_colctC,caption='Table 24a. Time (in Days) from Verification to Research Baseline Collection for Participants Verified Before 08/01/2022',row.names=FALSE, align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE) %>% kable_styling(latex_options = "scale_down")
...
tabbB <- knitr::kable(verif_BSL_colctD,caption='Table 24b. Time (in Days) from Verification to Research Baseline Collection for Participants Verified on or After 08/01/2022',row.names=FALSE, align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% kable_styling(latex_options = "scale_down")
...
knitr::kable(verif_BSL_colctA,caption='Table 25a. Time (in Days) from Verification to Clinical Baseline Collection for Participants Verified Before 02/01/2023',row.names=FALSE, align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% 
  kable_styling(latex_options = "scale_down")

knitr::kable(verif_BSL_colctB,caption='Table 25b. Time (in Days) from Verification to Clinical Baseline Collection for Participants Verified on or After 02/01/2023',row.names=FALSE, align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% 
  kable_styling(latex_options = "scale_down")




AF26 <- knitr::kable(verif_baseline_26_Af[c(1,2,7:9,3:6), ],caption = 'Table 26. Time (in Days) from Verification to Clinical Baseline Collection for \n Participants Verified After 06/01/2022, by Campaign Type',row.names=FALSE, booktabs = T, linesep = "", format.args = list(big.mark = ","), align = c("l", "c", "c","c", "c", "c", "c", "c", "c", "c", "c","c", "c","c"), col.names=c("Site",  'Number of Baseline Collections',"Min", "Median", "Mean", "SD", "Max", 'Number of Baseline Collections', "Min", "Median", "Mean", "SD", "Max","Total Number of Baseline Collections") ) %>% kable_styling(latex_options = "scale_down") %>% add_indent(c(1:9)) %>% add_header_above(c(" " = 1, "Upcoming Appointment" = 6, "All Other Campaigns" = 6,  " "=1)) %>% landscape() 
...
tabl27 <- knitr::kable(verif_draw_order,caption='Table 27. Time (in Days) from Verification to Draw Order Placement',row.names=FALSE, align=c("l","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% 
  kable_styling(latex_options = "scale_down")
...
knitr::kable(avg_draw_order, caption='Table 28. Time (in Days) from Draw Order Placement to Clinical Collection by Site', row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "scale_down") #%>% landscape()
