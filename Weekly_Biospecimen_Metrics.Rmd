...
biospe= biospe  %>% mutate(UC_Sites= case_when(d_951355211==777644826 ~ "UC-DCAM",
                                       ...
                                       d_951355211==489380324 ~ "River East",
                                       d_951355211==120264574 ~ "South Loop",
                                       d_951355211==3195182099 ~ "UCM Pop-Up",
                                       d_951355211==940329442 ~ "Orland Park"))
...
```{r Table28,include=FALSE, echo=FALSE, warning=FALSE}
...
#crosstable.coll_bptl1 %>% gt::gt(groupname_col = "Site")
...
```{r, Table29, include=FALSE, echo=FALSE, warning=FALSE}
...
coll_bptl_diff <- coll_bptl_diff %>% mutate(hrs_past = difftime(as.POSIXct(ymd_hms(any_collection)), as.POSIXct(ymd_hms(d_556788178)), units="hours"))
...
ggplot(scatMF, aes(x=as.Date(d_556788178), y=hrs_past)) + 
...
ggplot(scatSF, aes(x=as.Date(d_556788178), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) + 
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
ggplot(scatUC, aes(x=as.Date(d_556788178), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) +
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
ggplot(scatKPCO, aes(x=as.Date(clin_coll_bu), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) + 
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
ggplot(scatKPGA, aes(x=as.Date(clin_coll_bu), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) +
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
ggplot(scatKPHI, aes(x=as.Date(clin_coll_bu), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) + 
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
ggplot(scatKPNW, aes(x=as.Date(clin_coll_bu), y=hrs_past)) + 
    geom_point() + scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) +
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
    theme(panel.background = element_blank(),         
        #legend.title = element_text(size=7),         
...
#HP
# Combine the data
scatRHP$coldate <- scatRHP$d_556788178
...
combined_plotHP <- ggplot(combined_dataHP, aes(x = as.Date(coldate), y = hrs_past, color = Group)) +
  geom_point() +
...
#HF
scatRHF$coldate <- scatRHF$d_556788178
scatCHF$coldate <- scatCHF$clin_coll_bu
combined_dataHF <- rbind(cbind(scatRHF, Group = "Research"), cbind(scatCHF, Group = "Clinical"))

# Create a scatter plot with colored points
combined_plotHF <- ggplot(combined_dataHF, aes(x = as.Date(coldate), y = hrs_past, color = Group)) +
  geom_point() +
  scale_color_manual(values = c("Research" = "red", "Clinical" = "blue")) +
  scale_x_date(name="Date",date_labels = "%y-%m-%d", date_breaks = "2 weeks", expand=c(0,0)) +
  scale_y_continuous(name="Hours to BPTL Receipt",  breaks=seq(0,168,24), limits = c(0, 168), expand = c(0, 0)) +
