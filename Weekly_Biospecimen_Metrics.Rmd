...
# Set IRB defined race, sex, and Hispanic ethicity
coll_sett_all_m1 = coll_sett_all_m1 %>%  
  mutate(irb_race= case_when(d_949302066!=231311385 ~ "Module 1 Not Yet Completed",
                         d_949302066==231311385 & multi_racial==1 ~ "More than One Race",
                         d_949302066==231311385 &  (D_384191091_D_384191091_D_412790539==1 | 
                                                      D_384191091_D_384191091_D_973565052==1) ~ "White",
                         d_949302066==231311385 &  D_384191091_D_384191091_D_583826374==1 ~ "American Indian/Alaska Native",
                         ...
                         d_949302066==231311385 &  D_384191091_D_384191091_D_586825330==1 ~ "Native Hawaiian or Other Pacific Islander",
                         TRUE  ~ "Unknown"),
         race_hisp= case_when(d_949302066==231311385 & D_384191091_D_384191091_D_706998638==0 ~ "No",
                              d_949302066==231311385 & D_384191091_D_384191091_D_706998638==1 ~ "Yes",
                              TRUE  ~ "Unknown"),
         race_hisp = factor(race_hisp, levels=c("Yes", "No", "Unknown")),
         irb_race = fct_relevel(irb_race, "Module 1 Not Yet Completed", after = Inf))
...
verif_BSL_colctA_total <- BSL_colctA %>% 
  dplyr::summarize(Site = "All Sites",
                   'Number of Clinical Collections'= scales::comma(n()),
                   Min = round(min(time,na.rm = TRUE), digits=1),
                   Q1 = round(quantile(time, 0.25,na.rm = TRUE), digits=1),
...
verif_BSL_colctA <- rbind(verif_BSL_colctA, verif_BSL_colctA_total)
...
verif_BSL_colctB_total <- BSL_colctB %>% 
  dplyr::summarize(Site = "All Sites",
                   'Number of Clinical Collections'= scales::comma(n()),
                   Min = round(min(time,na.rm = TRUE), digits=1),
                   Q1 = round(quantile(time, 0.25,na.rm = TRUE), digits=1),
...
verif_BSL_colctB <- rbind(verif_BSL_colctB, verif_BSL_colctB_total)
