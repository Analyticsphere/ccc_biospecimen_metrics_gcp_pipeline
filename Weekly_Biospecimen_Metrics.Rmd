...
recrver1 <- recrver1 %>%  mutate(Clin_Site_location=case_when(
                                  ...
                                  d_173836415_d_266600170_d_185243482 == 1120190010 | 
                                    d_173836415_d_266600170_d_452847912 == 1120190010 ~ "Jackson Professional Building",
...
```{r Section6_Figures2, eval=TRUE,echo=FALSE, warning = FALSE, message = FALSE}
#Figure 6.2
...
fig7_1 <- ggplot(all_shipped_2_filtered, aes(x = Site)) +
  ...
  ggtitle("Figure 7.1. Baseline- Total Initial Kits Received of Total Initial Kits Shipped or Received \n at Least 2 Weeks Ago, by Site")
