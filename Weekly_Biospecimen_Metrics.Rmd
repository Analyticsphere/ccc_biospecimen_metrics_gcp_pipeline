...
col_num_1.1 <- col_num_1.1 %>%
  mutate(Site_Group = case_when(
    ...
    `Collection Location` %in% c("Lake Hallie", "Marshfield", "MF Pop-Up", "Minocqua", "Weston", "Wisconsin Rapids", "Rice Lake", "Colby Abbotsford", "Merrill", "Stevens Point") ~ "Marshfield Clinic Health System",
...
Hrs_bptl_rsch <- Hrs_bptl_rsch_summ  %>%
  ...
  gt::tab_style(style = list(gt::cell_text(weight = "bold")),
                locations = gt::cells_row_groups()) %>% 
  gt::tab_options(table.width = "100%", table.align = "left", table.font.size = "smaller")
