...
table7_2after2 <- knitr::kable(all_shipped_after2,format.args = list(big.mark = ","),
                              ...
                              row.names=FALSE, align=c("l","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "HOLD_position")
add_footnote(table7_2after2, "Query for addresses to print was updated on 8/28/2024 to pull most recent clinical collection date/time stamp first. Kit return method remained as FedEx.", notation = "none")
