...
fig7_1 <- ggplot(all_shipped_2_filtered, aes(x = Site)) +
  ...
  ggtitle("Figure 7.1. Baseline- Total Kits Received of Total Kits Shipped \n Up To 1 Week Ago, by Site")
...
table7.4 <- knitr::kable(Table7.4,
                               caption='Table 7.4: Baseline- Time (in Days) from Home Mouthwash Kit Shipment to BPTL Receipt \n (kits shipped before 6/17/2024)',
...
knitr::kable(Table7.5,
             caption='Table 7.5: Baseline- Time (in Days) from Clinical Collection to Home Mouthwash Kit Shipment',
             row.names=FALSE, align=c("l","c","c","c","c","c","c"),digits=1, booktabs = TRUE)%>% kable_styling(latex_options = "HOLD_position")


knitr::kable(table32_pct,
             caption='Table 7.6: Baseline- Kit Conditions Among Received Home Mouthwash Kits',
...
tab7_8 <- knitr::kable(table7_8_totals ,
                       ...
                       caption='Table 7.7: Baseline- Mouthwash Biospecimen Survey Status Among Received Home Mouthwash Kits', 
