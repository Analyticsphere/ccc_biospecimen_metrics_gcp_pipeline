...
knitr::kable(verif_BSL_colctD,
                      ...
                      row.names=FALSE, align=c("l","c","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% 
  kable_styling(latex_options = "scale_down") %>% 
  footnote(general = "August 2022 marks when research collection appointments were routinely offered to all new recruits at or near the time of verification. UChicago participant verification largely occurs at or near the time of collection.",
           ...
           escape = FALSE, 
           threeparttable = TRUE) %>% 
  footnote(paste0(nrow(BSL_colctD), " research collection visits occurred for participants verified before 8/1/2022."))
...
add_footnote(BSL_A,"Note: Baseline Clinical Collections were launched in February 2023 at the KP sites; June 2023 at Henry Ford; December 2023 at HealthPartners; April 2024 at Sanford; June 2024 at UChicago and add 90th percentile.", notation = "none")
...
BSL_B <-knitr::kable(verif_BSL_colctB,
                     ...
                     row.names=FALSE,  align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>%  kable_styling(latex_options = "scale_down")
add_footnote(BSL_B,"Note: Baseline Clinical Collections were launched in February 2023 at the KP sites; June 2023 at Henry Ford; December 2023 at HealthPartners; April 2024 at Sanford; June 2024 at UChicago and add 90th percentile.", notation = "none")
...
tabl27 <- knitr::kable(verif_draw_order,
                       caption='Table 4.6: Baseline- Time (in Days) from Verification to Draw Order Placement',row.names=FALSE, align=c("l","c","c","c","c","c","c","c"),digits=1, booktabs = TRUE)  %>% kable_styling(latex_options = "scale_down")
...
knitr::kable(Hrs_bptl_clinSF, 
             ...
             caption='Table 5.5: Baseline- Time (in Hours) from Clinical Collection to Receipt by Clinic Location \n Sanford Health', 
...
(d_906417725='104430631'  or DATE(d_614264509) > '2024-03-29')  and
 (d_685002411_d_277479354='104430631'  or DATE(d_262357957) > '2024-03-29')  and
(d_747006172='104430631' or 
DATE(SAFE.PARSE_TIMESTAMP('%Y-%m-%d %H:%M:%S', CAST(d_659990606 AS STRING))) > '2024-03-29') and 
(d_987563196='104430631' or DATE(d_772354119) > '2024-03-29') and 
d_173836415_d_266600170_d_156605577='353358909' and 
DATE(d_173836415_d_266600170_d_740582332) >= '2024-03-29'"
