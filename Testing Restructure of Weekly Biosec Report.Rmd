...
where Connect_ID IS NOT NULL and d_906417725='104430631'  and 
(d_747006172='104430631' or DATE(d_659990606) > '2024-03-29') and 
(d_987563196='104430631' or DATE(d_772354119) > '2024-03-29') and 
  ((DATE(d_173836415_d_266600170_d_982213346) >=  '2024-03-29' OR d_173836415_d_266600170_d_982213346 IS NULL) AND
  (DATE(d_173836415_d_266600170_d_139245758) >= '2024-03-29' OR d_173836415_d_266600170_d_139245758 IS NULL) AND
  NOT (d_173836415_d_266600170_d_982213346 IS NULL AND d_173836415_d_266600170_d_139245758 IS NULL))"
...
d_633640710_d_950521660, d_633640710_d_545319575, d_633640710_d_938338155, d_633640710_d_205954477, d_633640710_d_289239334,d_633640710_d_992420392, d_633640710_d_541085383,d_633640710_d_427719697, d_633640710_d_100618603, d_426588510, d_221592017
 ...
 left join `nih-nci-dceg-connect-prod-6d04.FlatConnect.kitAssembly_JP` kt
 ...
 and d_906417725='104430631'  and d_747006172='104430631' and d_987563196='104430631' and 
  ((DATE(d_173836415_d_266600170_d_982213346) >=  '2024-03-29' OR d_173836415_d_266600170_d_982213346 IS NULL) AND
  (DATE(d_173836415_d_266600170_d_139245758) >= '2024-03-29' OR d_173836415_d_266600170_d_139245758 IS NULL) AND
  NOT (d_173836415_d_266600170_d_982213346 IS NULL AND d_173836415_d_266600170_d_139245758 IS NULL))"
...
# ### Need only a subset if the participants table for this join
# kit_table_int_rec <- kit_table %>%  filter(Kit_Status_int=="Received")
# 
# dim(kit_table_int_rec)
# dim(kit_assembly)
# 
# kit_table$Connect_ID <- as.numeric(kit_table$Connect_ID)
# kit_table$d_173836415_d_266600170_d_319972665_d_687158491 <- as.character(kit_table$d_173836415_d_266600170_d_319972665_d_687158491)
# 
# kit_assembly$Connect_ID <- as.numeric(kit_assembly$Connect_ID)
# kit_assembly$KitAssembledID <- as.character(kit_assembly$KitAssembledID)
# 
# joined_kit_table <- left_join(kit_table_int_rec, kit_assembly, by = c("d_173836415_d_266600170_d_319972665_d_687158491" = "KitAssembledID"))
# joined_kit_table2 <- left_join(kit_assembly, kit_table_int_rec, by = "Connect_ID")
# 
# dim(joined_kit_table)
# 
# table(joined_kit_table$Card_Status)
# table(kit_assembly$Card_Status)
...
status_elgB <-kit_table %>%
  filter(!is.na(d_173836415_d_266600170_d_541483796_d_759651991)) %>% 
  tbl_cross(
    row = Site,
    col = Kit_Status_r1,
    digits=c(0,1),
...
status_elgC <- kit_table %>%
  filter(!is.na(d_173836415_d_266600170_d_641006239_d_759651991)) %>% 
  tbl_cross(
    row = Site,
    col = Kit_Status_r2,
    digits=c(0,1),
...
Coll_Card_StatusBF <- kit_assembly %>% dplyr::select(Site, Card_Status )  %>% tbl_cross(
  row = Site,
  col = Card_Status,
  digits=c(0,1),
  percent = "row",
...
table7_9 <- kit_table %>%  filter((Kit_Status_r2=="Received" | Kit_Status_r1=="Received" | Kit_Status_int=="Received") & 
...
table7_10 <- kit_table %>%  filter((Kit_Status_r2=="Received" | Kit_Status_r1=="Received" | Kit_Status_int=="Received") & 
                                    as.Date(d_173836415_d_266600170_d_319972665_d_661940160)>="2024-05-22") %>%
  mutate(MWSrvy_status = case_when(d_547363263==972455046 ~ "Not Started",
                                   d_547363263==615768760 ~ "Started",
                                   d_547363263==231311385 ~ "Submitted"),
