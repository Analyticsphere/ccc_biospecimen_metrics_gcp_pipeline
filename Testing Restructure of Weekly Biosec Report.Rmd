...
#Ops doesn't wnt the total column to have percentaes 
cross__table[["table_body"]]$stat_0 <- sapply(strsplit(cross__table[["table_body"]]$stat_0, " "), "[", 1)

#Ops doesn't like the grouped by variables on a different line the column labels
cross_table_df <- as.data.frame(cross__table)[-1, ]
  
#colnames(cross_table_df)[4] <- "Total Verified \n Participants"
}
...
kitassembly <- "SELECT * FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.kitAssembly` where Connect_ID IS NOT NULL"
...
## I think 'undeliverable', 'no status', 'initialized', 'address printed', and 'assigned' don't show up in the kit assembly table?
...
## Add a new Table 7.2: Of participants where "Kit Request Eligible" = yes and "Kit Request Eligible" date was at least 24 hours ago, how many have kit status that is not null. (distrbution of kit statuses) https://github.com/episphere/connect/issues/1326#issuecomment-2960611399
