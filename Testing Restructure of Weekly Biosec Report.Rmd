...
#                   caption='Table 1.7: Baseline Collection Setting Among Biospecimen Collections by Specimen Type', 
...
#                     caption='Table 1.8: Baseline Collection Setting Among Biospecimen Collections by Specimen Type, Henry Ford Health', 
#                     row.names=FALSE, align=c("l", rep("c", 3)), format.args = list(big.mark = ","), booktabs = TRUE)   
...
#                     col.names=c("Collection Setting","Any Blood Collected", "Urine Collected", "Mouthwash Collected"), 
#                     caption='Table 1.9: Baseline Collection Setting Among Biospecimen Collections by Specimen Type, HealthPartners', 
#                     row.names=FALSE, align=c("l",rep("c", 3)), format.args = list(big.mark = ","), booktabs = TRUE)   
...
#                     col.names=c("Collection Setting","Any Blood Collected", "Urine Collected", "Mouthwash Collected"), 
#                     caption='Table 1.10: Baseline Collection Setting Among Biospecimen Collections by Specimen Type, Sanford Health', 
#                     row.names=FALSE, align=c("l",rep("c", 3)), format.args = list(big.mark = ","), booktabs = TRUE)
...
#                     col.names=c("Collection Setting","Any Blood Collected", "Urine Collected", "Mouthwash Collected"), 
#                     caption='Table 1.11: Baseline Collection Setting Among Biospecimen Collections by Specimen Type, University of Chicago Medicine', 
#                     row.names=FALSE, align=c("l",rep("c", 3)), format.args = list(big.mark = ","), booktabs = TRUE)
...
```{r RequestKits12,echo=FALSE, message=FALSE,warning=FALSE,results='hold', include=FALSE}
...
req_rec_lags <- kit_request_table %>%
  mutate(
    ...
    Requested_2Weeks = as.numeric(difftime(currentDate, d_173836415_d_266600170_d_319972665_d_759651991, units = "days")) >= 14,
    #All Received
    Received = Kit_Status_int == "Received",
    # Invited at least 3 weeks ago
    Invited_3Weeks = as.numeric(difftime(currentDate, d_173836415_d_266600170_d_319972665_d_278539982, units = "days")) >= 21) %>%
...
knitr::kable(req_rec_lags,
             ...
             caption='8.12: Baseline- Home Mouthwash Kits Requested Among Participants Invited to Request a Kit (with time lags)',
