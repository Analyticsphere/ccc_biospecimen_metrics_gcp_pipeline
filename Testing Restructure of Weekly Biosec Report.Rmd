...
test30 <-  test30 %>%
  mutate(ctime = as.numeric(difftime(d_173836415_d_266600170_d_319972665_d_826941471,d_173836415_d_266600170_d_319972665_d_661940160,units="days"))) %>% 
  filter(ctime>0)
...
kit_set_col_2 <- kit_table %>% filter(Kit_Status_int=="Received") %>% 
  mutate(col.Monday.date = floor_date(as.Date(d_173836415_d_266600170_d_319972665_d_826941471), unit = "week", week_start = 1))
...
kit_table2 <- kit_table %>%  filter(!is.na(d_173836415_d_266600170_d_319972665_d_661940160)) %>% 
  mutate(col.Monday.date = floor_date(as.Date(d_173836415_d_266600170_d_319972665_d_661940160), unit = "week", week_start = 1))
...
survey_cc_int <- kit_table %>%  
  filter(!is.na(d_195145666) & !is.na(d_173836415_d_266600170_d_448660695) & d_195145666 > as.Date("2025-05-01") & d_547363263 == '231311385') %>% 
