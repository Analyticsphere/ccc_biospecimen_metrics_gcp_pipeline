...
menstrual_funct <- function(data, CID, Title, factor_levels = NULL){  
  CID_SYM <- rlang::ensym(CID)
...
#MENSTPRD
menstrual_funct(BUM_tib,D_380603392, "MENSTPRD: Had Menstrual Period in the Last 12 Months",
                   factor_levels = c("Yes", "No"))


#MENST60
one_logic_funct(BUM_tib,D_112151599, "MENST60: Had Menstrual Period in the Last 60 Days", D_380603392, "353358909",
                   factor_levels = c("Yes", "No")) 
...
#PREGNANT
menstrual_funct(BUM_tib,D_518916981, "PREGNANT: Currently Pregnant",
                   factor_levels = c("Yes", "No"))


#PREG3MON
one_logic_funct(BUM_tib,D_234714655, "Table 13: Been Pregnant in the Last 3 Months", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 

#BRSTFD
menstrual_funct(BUM_tib,D_798452445, "Table 14: Currently Breastfeeding",
                   factor_levels = c("Yes", "No"))

#BRSTFD3MON
one_logic_funct(BUM_tib,D_563539159, "Table 15: Breastfed in the Last 3 Months", D_798452445, "104430631",
                   factor_levels = c("Yes", "No")) 

#CONTRACEPT
one_logic_funct(BUM_tib,D_875535246, "Table 16: Used Hormonal Contraceptives in the Last Month", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 

#HORMONE
one_logic_funct(BUM_tib,D_130311122, "Table 17: Used Prescription Hormone Therapy in the Last Month", D_518916981, "104430631",
                   factor_levels = c("Yes", "No")) 
...
#BRUSH2
one_logic_funct(BUM_tib,D_498984275, "Table 123: Frequency Using a Toothbrush in the Last Month", D_479143504_D_203919683, "1",
...
#FLOSS2
one_logic_funct(BUM_tib,D_205713835, "Table 124: Frequency Using Floss in the Last Month", D_479143504_D_807884576, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#WTRPICK2
one_logic_funct(BUM_tib,D_353467497, "Table 125: Frequency Using a Water Based Flosser or Pick in the Last Month", D_479143504_D_165596977, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )



#TONGUE2
one_logic_funct(BUM_tib,D_429994023, "Table 126: Frequency Using a Tongue Scrubber in the Last Month", D_479143504_D_578402172, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )



#WHITE2
one_logic_funct(BUM_tib,D_499977481, "Table 127: Frequency Using Teeth Whitener in the Last Month", D_479143504_D_184513726, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )
...
#MWALC
one_logic_funct(BUM_tib,D_349659426, "Table 129: Frequency Using Alcohol Based Mouthwash", D_406270109_D_950773275, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWALCFREE
one_logic_funct(BUM_tib,D_766370065, "Table 130: Frequency Using Alcohol Free Mouthwash", D_406270109_D_762727133, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )



#MWCHLOR
one_logic_funct(BUM_tib,D_520416570, "Table 131: Frequency Using Chlorhexidine Mouthwash", D_406270109_D_877842367, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWFLOURIDE
one_logic_funct(BUM_tib,D_921972241, "Table 132: Frequency Using Flouride Mouthwash", D_406270109_D_886771318, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWPEROX
one_logic_funct(BUM_tib,D_526973271, "Table 133: Frequency Using Peroxide Mouthwash", D_406270109_D_404389800, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWCETYL
one_logic_funct(BUM_tib,D_460873842, "Table 134: Frequency Using Cetylpyridinium Cloride Mouthwash", D_406270109_D_463302301, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWSENSITIVE
one_logic_funct(BUM_tib,D_430060900, "Table 135: Frequency Using Mouthwash for Sensitive Teeth", D_406270109_D_259744087, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )


#MWDRY
one_logic_funct(BUM_tib,D_800752981,  "Table 136: Frequency Using Mouthwash for Dry Mouth", D_406270109_D_523660949, "1",
factor_levels = c("Never","Less than Once Per Week", "1-2 Times per Week", "3-5 Times per Week", "Once per Day", "Two or more times per day") )
...
#ANTIBIOTIME
one_logic_funct(BUM_tib,D_318641324, "Table 148: Date Antiobiotic Last Taken", D_736393021, "353358909",
