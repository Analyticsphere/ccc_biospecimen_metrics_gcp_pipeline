...
BUM_dict <- list("104430631"="No", "353358909"="Yes", "178420302"="Unknown", "536341288"="Female", "576796184"="Unknown", "654207589"="Male",
...
avg_s <- BUM_tib %>%  filter((d_827220437==531629870 |  d_827220437==548392715 | d_827220437==303349821 | d_827220437==657167265 | d_827220437==809703864) & !is.na(D_867307558))
#avg$Site<- droplevels(avg$Site)

#(D_867307558==110092955 ~ "Same day",D_867307558==952212668 ~ "The Day before"))

avg_coll2 <- avg_s %>%  mutate(D_191057574V=coalesce(D_191057574, D_191057574_V2))
...
dt_PERMTTHLOST2= BUM_tib %>%   
  filter(BUM_tib$d_222161762>as.Date("2022-12-01"))
...
#TEETHLOSTOTH
TEETHLOSTOTH <- BUM_tib %>%  select(Connect_ID, D_360678252) %>%  filter((BUM_tib$D_899251483_V2_D_886864375==1) & (BUM_tib$d_822499427>as.Date("2022-12-1")))
