...
data_raw <- read_bsi_gcs(monday_this_week)
...
```{r Recurring_Metrics_Excel, echo=FALSE, message=FALSE, warning = FALSE}

# Exports -----------------------------------------------------------------



boxfolder <- "382627330982"
...
# -- Standalone RM3 plot_data xlsx -------------------------------------------
# wb_rm3 <- createWorkbook()
# addWorksheet(wb_rm3, "RM3_Receipt_to_Processing_Dates")
# writeData(wb_rm3, "RM3_Receipt_to_Processing_Dates", rm3_metric$plot_data)
# 
# center_style <- createStyle(halign = "center", valign = "center")
# setColWidths(wb_rm3, sheet = "RM3_Receipt_to_Processing_Dates", cols = 1:50, widths = "auto")
# addStyle(
#     wb_rm3,
#     sheet = "RM3_Receipt_to_Processing_Dates",
#     style = center_style,
#     rows = 1:500,
#     cols = 1:50,
#     gridExpand = TRUE,
...
# saveWorkbook(
#     wb_rm3,
#     file = glue("RM3_processing_time_table_{download_date}_boxfolder_{boxfolder}.xlsx"),
#     overwrite = TRUE
# )
